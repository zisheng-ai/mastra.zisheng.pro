...
<PropertiesTable
  ...
  },
  {
    ...
    type: "'exact' | 'approx'",
    isOptional: true,
    description: 'Oracle のクエリモード。近似ベクトルインデックスが設定されていない場合、デフォルトで完全検索を使用します。',
  },
  {
    name: 'targetAccuracy',
    type: 'number',
...
<PropertiesTable
  ...
  },
  {
    ...
    isOptional: true,
    defaultValue: "'MEMORY'",
    description: "Oracle ALTER SYSTEM のスコープ。データベース再起動後も設定を保持するには 'SPFILE' または 'BOTH' を使用します。",
  },
]}
/>
