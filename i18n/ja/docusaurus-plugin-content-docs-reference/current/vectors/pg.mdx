...
### ホスト、ポート、データベースの設定 {/* #hostportdatabase-configuration */}
...
### インデックスの再作成動作 {/* #index-recreation-behavior */}
...
### fastembed を使用したローカル埋め込み {/* #local-embeddings-with-fastembed */}
