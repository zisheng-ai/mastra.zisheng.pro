...
## データベース固有の型 {/* #database-specific-types */}
...
<Tabs>
  <TabItem value="basic-usage" label="基本的な使用方法">
    ### 基本的なデータベース設定 {/* #basic-database-configuration */}
  ...
  <TabItem value="runtime-override" label="実行時のオーバーライド">
    ### 実行時の設定オーバーライド {/* #runtime-configuration-override */}
  ...
  <TabItem value="multi-database" label="複数データベース">
    ### 複数データベースの設定 {/* #multi-database-configuration */}
