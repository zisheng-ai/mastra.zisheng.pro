...
### Mastra 形式（デフォルト） {/* #mastra-format-default */}
...
### AI SDK v5 以降の形式 {/* #ai-sdk-v5-format */}
...
### オプションを使用する高度な例 {/* #advanced-example-with-options */}
...
## Responses WebSocket transport {/* #responses-websocket-transport */}
