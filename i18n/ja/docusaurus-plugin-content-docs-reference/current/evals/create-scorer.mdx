...
<PropertiesTable content={[
  { name: 'description', type: 'string', isOptional: false, description: 'この前処理ステップの処理内容の説明。' },
  { name: 'outputSchema', type: 'StandardJSONSchemaV1', isOptional: false, description: 'preprocess ステップの期待される出力に対する Standard JSON Schema。' },
  { name: 'createPrompt', type: 'function', isOptional: false, description: '関数：({ run, results }) => string。LLM に渡すプロンプトを返します。' },
  { name: 'judge', type: 'object', isOptional: true, description: 'このステップ用の任意の LLM judge（メインの judge を上書きできます）。Judge Object セクションを参照してください。' },
]}/>
...
<PropertiesTable content={[
  { name: 'run.input', type: 'any', isOptional: false, description: "スコアラーに渡される入力レコード。Agent では `[{ role: 'user', content: 'hello world' }]` のようなユーザーメッセージの配列、Workflow では Workflow の入力です。" },
  { name: 'run.output', type: 'any', isOptional: false, description: "スコアラーに渡される出力レコード。Agent では通常 Agent の応答、Workflow では Workflow の出力です。" },
  { name: 'run.runId', type: 'string', isOptional: false, description: 'このスコアリング run の一意な識別子。' },
  { name: 'run.requestContext', type: 'object', isOptional: true, description: '評価対象の Agent または Workflow ステップからの Request Context（任意）。' },
  { name: 'results.preprocessStepResult', type: 'any', isOptional: true, description: '定義されている場合は preprocess ステップの結果（任意）。' },
]}/>
...
<PropertiesTable content={[
  { name: 'description', type: 'string', isOptional: false, description: 'この分析ステップの処理内容の説明。' },
  { name: 'outputSchema', type: 'StandardJSONSchemaV1', isOptional: false, description: 'analyze ステップの期待される出力に対する Standard JSON Schema。' },
  { name: 'createPrompt', type: 'function', isOptional: false, description: '関数：({ run, results }) => string。LLM に渡すプロンプトを返します。' },
  { name: 'judge', type: 'object', isOptional: true, description: 'このステップ用の任意の LLM judge（メインの judge を上書きできます）。Judge Object セクションを参照してください。' },
]}/>
...
<PropertiesTable content={[
  ...
  { name: 'run.requestContext', type: 'object', isOptional: true, description: '評価対象の Agent または Workflow ステップからの Request Context（任意）。' },
  { name: 'results.preprocessStepResult', type: 'any', isOptional: true, description: '定義されている場合は preprocess ステップの結果（任意）。' },
  { name: 'results.analyzeStepResult', type: 'any', isOptional: true, description: '定義されている場合は analyze ステップの結果（任意）。' },
]}/>
...
<PropertiesTable content={[
  { name: 'description', type: 'string', isOptional: false, description: 'このスコアリングステップの処理内容の説明。' },
  { name: 'outputSchema', type: 'StandardJSONSchemaV1', isOptional: false, description: 'generateScore ステップの期待される出力に対する Standard JSON Schema。' },
  { name: 'createPrompt', type: 'function', isOptional: false, description: '関数：({ run, results }) => string。LLM に渡すプロンプトを返します。' },
  { name: 'judge', type: 'object', isOptional: true, description: 'このステップ用の任意の LLM judge（メインの judge を上書きできます）。Judge Object セクションを参照してください。' },
]}/>
...
<PropertiesTable content={[
  { name: 'calculateScore', type: 'function', isOptional: false, description: "関数：({ run, results, analyzeStepResult }) => number。LLM の構造化出力を数値スコアに変換します。" },
]}/>
...
<PropertiesTable content={[
  ...
  { name: 'results.preprocessStepResult', type: 'any', isOptional: true, description: '定義されている場合は preprocess ステップの結果（任意）。' },
  { name: 'results.analyzeStepResult', type: 'any', isOptional: true, description: '定義されている場合は analyze ステップの結果（任意）。' },
  { name: 'score', type: 'number', isOptional: false, description: 'generateScore ステップで計算されたスコア。' },
]}/>
...
<PropertiesTable content={[
  { name: 'description', type: 'string', isOptional: false, description: 'この理由生成ステップの処理内容の説明。' },
  { name: 'createPrompt', type: 'function', isOptional: false, description: '関数：({ run, results, score }) => string。LLM に渡すプロンプトを返します。' },
  { name: 'judge', type: 'object', isOptional: true, description: 'このステップ用の任意の LLM judge（メインの judge を上書きできます）。Judge Object セクションを参照してください。' },
]}/>
