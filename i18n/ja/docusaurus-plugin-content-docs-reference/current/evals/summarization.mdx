...
# Summarization スコアラー {/* #summarization-scorer */}
...
## 要約の評価 {/* #summarization-evaluation */}
...
### 2 つの軸の読み方 {/* #reading-the-two-axes */}
...
### スコアに含まれない要素 {/* #what-the-score-leaves-out */}
...
### 実行入力を要約する {/* #summarizing-the-run-input */}
...
### 別の場所にある文書を要約する {/* #summarizing-a-document-from-elsewhere */}
...
## Faithfulness との比較 {/* #comparison-with-faithfulness */}
