...
## システムメッセージの抽出 {/* #system-message-extraction */}
...
## Tool 呼び出しの抽出 {/* #tool-call-extraction */}
...
## Trajectory ユーティリティ {/* #trajectory-utilities */}
...
#### span 型のマッピング {/* #span-type-mapping */}
