...
<PropertiesTable
  ...
  },
  {
    name: 'thread',
    type: 'SessionThread',
    description: 'アクティブな Thread のバインドと、Thread／メッセージの読み取り。以下の Thread メソッドを参照してください。',
  },
  {
    name: 'mode',
    type: 'SessionMode',
  ...
  },
  {
    ...
    description: 'スキーマで検証され、Session が所有する AgentController 状態。以下の State メソッドを参照してください。',
  },
  {
    name: 'browser',
