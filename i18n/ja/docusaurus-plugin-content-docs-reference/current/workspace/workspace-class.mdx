...
## Agent 向け Tool {/* #agent-tools */}

Workspace は設定内容に基づいて Agent に Tool を提供します。

### Filesystem の Tool {/* #filesystem-tools */}
