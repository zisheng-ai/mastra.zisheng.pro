...
### 保持対象テーブル {/* #retention-eligible-tables */}
...
## スケジュールに従って prune を実行する {/* #running-prune-on-a-schedule */}
...
## MongoDB TTL インデックス（prune の代替手段） {/* #mongodb-ttl-indexes-alternative-to-prune */}
...
### MongoDB で TTL インデックスを設定する {/* #setting-up-ttl-indexes-on-mongodb */}
