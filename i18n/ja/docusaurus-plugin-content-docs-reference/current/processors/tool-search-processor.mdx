...
### 状態の確認（従来の `'in-memory'` ストア） {/* #state-inspection-legacy-in-memory-store */}
...
## リクエスト対応のフィルタリング {/* #request-aware-filtering */}
...
## リクエストごとに解決された Tool を検索する {/* #searching-request-resolved-tools */}
...
## `autoLoad` による1ステップの検出 {/* #single-step-discovery-with-autoload */}
...
## 他の processor との組み合わせ {/* #combining-with-other-processors */}
