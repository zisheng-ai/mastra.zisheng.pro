...
<PropertiesTable
  content={[
  {
    ...
    description: "このステップのモデルを変更します。モデルインスタンス、または 'openai/gpt-5.5' のような router ID を指定できます。",
    isOptional: true,
  },
  {
    name: 'toolChoice',
  ...
  },
  {
    name: 'tools',
    type: 'ToolSet',
    description: 'このステップの Tool を置換または変更します。統合には spread を使用します：{ tools: { ...tools, newTool } }。',
    isOptional: true,
  },
  {
    name: 'messages',
