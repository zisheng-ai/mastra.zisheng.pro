...
<PropertiesTable
  content={[
  {
    name: 'apiKey',
    type: 'string',
    description: 'WorkOS API キー。ユーザー検証と組織管理のために WorkOS API で認証する際に使用されます。',
    isOptional: true,
  ...
  },
  {
    name: 'clientId',
    type: 'string',
    description: 'WorkOS Client ID。認可コードをアクセストークンと交換する際に、アプリケーションを識別します。',
    isOptional: true,
...
## サービストークンと JWT クレーム {/* #service-tokens-and-jwt-claims */}
