...
## 新しいスレッドを作成 {/* #create-a-new-thread */}
...
## 特定のスレッドを操作 {/* #working-with-a-specific-thread */}
...
### スレッドのメッセージを取得 {/* #retrieve-thread-messages */}
...
### ワーキングメモリを取得 {/* #get-working-memory */}
...
### ワーキングメモリを更新 {/* #update-working-memory */}
