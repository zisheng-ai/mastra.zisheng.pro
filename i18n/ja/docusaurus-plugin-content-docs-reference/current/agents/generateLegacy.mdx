...
# Agent.generateLegacy()（Legacy） {/* #agentgeneratelegacy-legacy */}
...
## Processor の再試行対応 {/* #processor-retry-support */}
...
### 移行の簡単な例 {/* #quick-migration-example */}

#### 変更前（Legacy） {/* #before-legacy */}
