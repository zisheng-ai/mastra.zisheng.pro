...
### 基本的な文字列 instructions {/* #basic-string-instructions */}
...
### Provider 固有の設定 {/* #provider-specific-configurations */}
...
### instructions 形式の混在 {/* #mixed-instruction-formats */}
    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            description:
              'Memory Thread の Resource ID。Thread を対象とするメッセージでは `threadId` とともに必須です。',
          },
          {
            name: 'threadId',
            type: 'string',
...
## `generate()` の Memory オプション {/* #generate-memory-options */}
...
## Editor による上書き {/* #editor-overrides */}
