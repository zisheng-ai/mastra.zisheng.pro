        ...
        parameters: [
          {
            name: 'speaker',
            type: 'string',
            description: "音声合成に使用する Voice ID（例：'en-US-JennyNeural'）。デフォルトの Voice を上書きします。",
            isOptional: true,
...
### Azure Speech Services と Azure OpenAI の違い {/* #azure-speech-services-vs-azure-openai */}
