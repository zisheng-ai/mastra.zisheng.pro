...
<PropertiesTable
  content={[
  {
    name: 'speaker',
    type: 'event',
    description: 'モデルから音声データを受信したときに送出されます。コールバックは NodeJS.ReadableStream を受け取ります。',
  },
  {
    name: 'speaking',
    type: 'event',
    description: '音声メタデータとともに送出されます。コールバックは { audioData?: Int16Array, sampleRate?: number } を受け取ります。',
  },
  {
    name: 'writing',
    type: 'event',
