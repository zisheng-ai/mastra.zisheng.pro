...
## native-audio の動作 {/* #native-audio-behavior */}
...
### Gemini API（開発環境） {/* #gemini-api-development */}
...
### Vertex AI（本番環境） {/* #vertex-ai-production */}
