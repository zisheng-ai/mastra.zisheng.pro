...
## Agent に Voice を追加する {/* #add-voice-to-agents */}
...
### Speech-to-Speech（STS） {/* #speech-to-speech-sts */}
...
### 複数の Voice Provider を使用する {/* #using-multiple-voice-providers */}
...
### AI SDK Model Provider を使用する {/* #using-ai-sdk-model-providers */}
