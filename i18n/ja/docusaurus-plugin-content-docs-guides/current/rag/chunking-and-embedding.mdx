...
# ドキュメントのチャンク分割と埋め込み {/* #chunking-and-embedding-documents */}
...
### 埋め込みの次元数を設定する {/* #configuring-embedding-dimensions */}
