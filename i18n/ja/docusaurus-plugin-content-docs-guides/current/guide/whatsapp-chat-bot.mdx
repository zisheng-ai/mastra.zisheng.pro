---
title: "ガイド：WhatsApp chat bot"
description: Mastra の Agent と Workflow を使用して受信メッセージを処理し、自然なテキストメッセージで応答する WhatsApp chat bot を作成します。
---
...
## Chat Agent の作成 {/* #creating-the-chat-agent */}
...
## Text Message Agent の作成 {/* #creating-the-text-message-agent */}
...
## Chat Workflow の作成 {/* #creating-the-chat-workflow */}
...
## Mastra 設定のセットアップ {/* #setting-up-mastra-configuration */}
...
## Chat bot のテスト {/* #testing-the-chat-bot */}
