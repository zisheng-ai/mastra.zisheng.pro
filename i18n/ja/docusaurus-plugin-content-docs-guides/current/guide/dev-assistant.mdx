...
# 開発アシスタントを構築する {/* #building-a-dev-assistant */}
...
### Vitest をインストールする {/* #install-vitest */}
...
## サンプルプロジェクトのファイルを追加する {/* #add-sample-project-files */}
...
## 開発アシスタントを作成する {/* #create-the-dev-assistant */}
