...
# Mastra を Amazon Bedrock AgentCore にデプロイする {/* #deploy-mastra-to-amazon-bedrock-agentcore */}
...
## 新しい AgentCore プロジェクトを作成する {/* #create-a-new-agentcore-project */}
...
## Agent プロジェクトを設定する {/* #set-up-the-agent-project */}
...
## Agent を初期化する {/* #initialize-the-agent */}
...
## Agent をデプロイする {/* #deploy-your-agent */}
