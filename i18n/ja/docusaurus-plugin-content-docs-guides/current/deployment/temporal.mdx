...
## Temporal と Mastra の連携 {/* #how-temporal-works-with-mastra */}
...
## Temporal を使用する Workflow を構築する {/* #building-a-temporal-backed-workflow */}

このガイドでは、値を増分するカウンターアプリケーションを例に、Temporal と Mastra を使用した Workflow の作成方法を説明します。

### Temporal を初期化する {/* #temporal-initialization */}
...
## Worker を実行する {/* #running-the-worker */}
