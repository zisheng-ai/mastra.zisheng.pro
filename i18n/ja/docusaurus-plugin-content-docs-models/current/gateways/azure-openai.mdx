...
# <img src="https://models.dev/logos/azure.svg" alt="Azure OpenAI ロゴ" className="inline w-8 h-8 mr-2 align-middle dark:invert dark:brightness-0 dark:contrast-200" />Azure OpenAI {/* #azure-openai */}
