...
## トレーシングを使用する場面 {/* #when-to-use-tracing */}
...
### デプロイ環境による Trace のタグ付け {/* #tagging-traces-with-the-deployment-environment */}
...
### `RequestContext` からの自動メタデータ {/* #automatic-metadata-from-requestcontext */}
...
#### 設定レベルでの抽出 {/* #configuration-level-extraction */}
...
#### リクエストごとの追加 {/* #per-request-additions */}
...
#### ネストされた値の抽出 {/* #nested-value-extraction */}
...
### Trace へのタグの追加 {/* #adding-tags-to-traces */}
...
#### 一般的なタグのパターン {/* #common-tag-patterns */}
...
### 機密性の高い入出力を非表示にする {/* #hiding-sensitive-inputoutput */}
...
#### 子 Span とメタデータの抽出 {/* #child-spans-and-metadata-extraction */}
...
## 子 Span の作成 {/* #creating-child-spans */}
...
#### 組み込み Processor {/* #built-in-processors */}
...
#### カスタム Processor の作成 {/* #creating-custom-processors */}
...
### カスタム Span Formatter {/* #custom-span-formatters */}
...
#### 複数の Formatter の連結 {/* #chaining-multiple-formatters */}
...
#### 非同期 Formatter {/* #async-formatters */}
...
## シリアル化オプション {/* #serialization-options */}
...
## Trace ID の取得 {/* #retrieving-trace-ids */}
...
### Agent の Trace ID {/* #agent-trace-ids */}
...
### Workflow の Trace ID {/* #workflow-trace-ids */}
...
## 外部トレーシングシステムとの統合 {/* #integrating-with-external-tracing-systems */}
...
### 外部 Trace ID の受け渡し {/* #passing-external-trace-ids */}
...
### OpenTelemetry との統合 {/* #opentelemetry-integration */}
...
### Workflow との統合 {/* #workflow-integration */}
...
### ID 形式の要件 {/* #id-format-requirements */}
...
### 例：Express ミドルウェア {/* #example-express-middleware */}
...
## トレースされる対象 {/* #what-gets-traced */}

Mastra は、次の対象に対して Span を自動的に作成します。

### Agent の操作 {/* #agent-operations */}
...
### Workflow の操作 {/* #workflow-operations */}
...
### リファレンスドキュメント {/* #reference-documentation */}
