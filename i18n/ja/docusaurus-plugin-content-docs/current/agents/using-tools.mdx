...
## Tool を使用する場面 {/* #when-to-use-tools */}
...
## Tool としての Agent {/* #agents-as-tools */}
...
## Tool としての Workflow {/* #workflows-as-tools */}
...
## 複数の Agent で Tool を共有する {/* #share-tools-across-agents */}
...
## モデル向けに出力を整形する {/* #shape-output-for-the-model */}
...
## UI とトランスクリプト向けに Tool のペイロードを変換する {/* #transform-tool-payloads-for-ui-and-transcripts */}
...
## Tool 呼び出しの前後でロジックを実行する {/* #run-logic-around-tool-calls */}
...
### 例：`onInputAvailable` と `onOutput` を使用する {/* #example-using-oninputavailable-and-onoutput */}
...
### UI で Tool の入力をストリーミングする {/* #streaming-tool-input-in-uis */}
...
## Tool の選択を制御する {/* #control-tool-selection */}
...
## ストリームレスポンスの `toolName` を制御する {/* #control-toolname-in-stream-responses */}
...
### Tool としてのサブ Agent と Workflow {/* #subagents-and-workflows-as-tools */}
...
### Provider の Web 検索を使用する {/* #use-provider-web-search */}
...
### ユーザーに質問する {/* #ask-the-user-a-question */}
...
### レビュー用の計画を提出する {/* #submit-a-plan-for-review */}
