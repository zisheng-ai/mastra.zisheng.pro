...
# Server Adapter {/* #server-adapters */}
...
## Server Adapter を使用する場面 {/* #when-to-use-server-adapters */}
...
## ルート単位での認証の上書き {/* #per-route-auth-overrides */}
...
## サーバー設定と Adapter オプションの違い {/* #server-config-vs-adapter-options */}
...
### Adapter が使用する設定 {/* #used-by-adapters */}
...
### Adapter のコンストラクター専用 {/* #adapter-constructor-only */}
...
### Adapter が使用しない設定 {/* #not-used-by-adapters */}
...
### Serverless モード {/* #serverless-mode */}
