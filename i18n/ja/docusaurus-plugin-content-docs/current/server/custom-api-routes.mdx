...
## OpenAPI ドキュメント {/* #openapi-documentation */}
...
### Swagger UI での表示 {/* #viewing-in-swagger-ui */}
...
### 認証 behavior {/* #authentication-behavior */}
...
### ユーザー情報へのアクセス {/* #accessing-user-information */}
...
## クライアント切断後も生成を継続する {/* #continue-generation-after-client-disconnect */}
