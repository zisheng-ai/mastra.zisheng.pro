...
# Sandbox へのデプロイ {/* #deploy-to-a-sandbox */}
...
## サポートされている Sandbox {/* #supported-sandboxes */}
...
### 各 URL が提供する内容 {/* #what-the-urls-serve */}
...
### プロバイダーの認証情報 {/* #provider-credentials */}
...
## プログラムによるデプロイ {/* #deploying-programmatically */}
...
## ルーティング階層 {/* #routing-tiers */}

### Tier 1：直接 URL {/* #tier-1-direct-url */}

デプロイごとに新しい URL が発行されても問題ない開発、デモ、CI では、出力された URL を直接使用します。

### Tier 2：実行時に解決 {/* #tier-2-resolve-at-runtime */}
...
### Tier 3：エンドユーザー向けの安定した URL {/* #tier-3-stable-url-for-end-users */}
