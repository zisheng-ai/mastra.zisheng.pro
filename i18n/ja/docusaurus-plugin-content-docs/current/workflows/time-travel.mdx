...
## タイムトラベルの仕組み {/* #how-time-travel-works */}
...
## 対象ステップを指定する {/* #specifying-the-target-step */}

対象ステップは、ステップ参照またはステップ ID で指定できます。

### ステップ参照を使用する {/* #using-step-reference */}
...
### ネストされた Workflow のステップ {/* #nested-workflow-steps */}
...
## 実行コンテキストを指定する {/* #providing-execution-context */}
...
## 失敗した Workflow を再実行する {/* #re-running-failed-workflows */}
...
## 中断した Workflow でタイムトラベルする {/* #time-travel-with-suspended-workflows */}
...
## タイムトラベルの結果をストリーミングする {/* #streaming-time-travel-results */}
...
## 初期状態を指定してタイムトラベルする {/* #time-travel-with-initial-state */}
...
### 実行中の Workflow {/* #running-workflow */}
...
## ネストされた Workflow のコンテキスト {/* #nested-workflows-context */}
...
### 失敗したステップをデバッグする {/* #debugging-failed-steps */}
...
### 新しい Workflow 実行でステップのロジックをテストする {/* #testing-step-logic-on-new-workflow-run */}
...
### 一時的な障害から復旧する {/* #recovering-from-transient-failures */}
