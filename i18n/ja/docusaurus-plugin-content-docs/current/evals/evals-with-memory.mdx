...
# Memory を使用した Evals {/* #evals-with-memory */}
...
## アプローチの選び方 {/* #when-to-use-which-approach */}
...
## `runEvals` でスレッドを共有する {/* #shared-thread-with-runevals */}
...
## `runEvals` で項目ごとにスレッドを分ける {/* #per-item-threads-with-runevals */}
...
## インラインタスクを使用した Dataset の実験 {/* #dataset-experiments-with-an-inline-task */}
