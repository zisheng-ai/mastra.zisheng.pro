...
# Gate と Verdict {/* #gates-and-verdicts */}
...
## Gate と Verdict を使用する場面 {/* #when-to-use-gates-and-verdicts */}
...
## Verdict の仕組み {/* #how-verdicts-work */}
...
## CI で Verdict を使用する {/* #using-verdicts-in-ci */}
