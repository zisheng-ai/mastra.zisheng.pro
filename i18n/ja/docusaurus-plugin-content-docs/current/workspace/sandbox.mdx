...
### ライフサイクルの所有権 {/* #lifecycle-ownership */}
...
### バックグラウンドプロセスの継続性 {/* #background-process-continuity */}
...
### Workspace の指示 {/* #workspace-instructions */}
...
## バックグラウンドプロセスのコールバック {/* #background-process-callbacks */}
