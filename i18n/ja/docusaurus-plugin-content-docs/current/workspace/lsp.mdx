...
## LSP 検査を使用する場面 {/* #when-to-use-lsp-inspection */}
...
## カスタム Language Server {/* #custom-language-servers */}
...
## 要件と制限 {/* #requirements-and-limitations */}
