...
## Semantic recall の仕組み {/* #how-semantic-recall-works */}
...
## `recall()` メソッドの使用 {/* #using-the-recall-method */}
...
## Recall の設定 {/* #recall-configuration */}
...
### Model Router の使用（推奨） {/* #using-the-model-router-recommended */}
...
### AI SDK パッケージの使用 {/* #using-ai-sdk-packages */}
...
### FastEmbed（ローカル）の使用 {/* #using-fastembed-local */}
...
## PostgreSQL インデックスの最適化 {/* #postgresql-index-optimization */}
...
## Semantic recall を無効にする {/* #disable-semantic-recall */}
...
## 呼び出されたメッセージの表示 {/* #viewing-recalled-messages */}
