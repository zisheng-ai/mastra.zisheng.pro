...
## すべての参加者で1つの `resourceId` を共有する {/* #share-one-resourceid-across-all-participants */}
...
## 各ユーザーメッセージに発言者の識別情報を付ける {/* #tag-each-user-message-with-the-speakers-identity */}
...
## Memory レイヤーとの組み合わせ {/* #combining-with-memory-layers */}
...
### メッセージ履歴のみ {/* #message-history-alone */}
...
### Observational Memory との組み合わせ（推奨） {/* #with-observational-memory-recommended */}
...
### working memory との組み合わせ {/* #with-working-memory */}
