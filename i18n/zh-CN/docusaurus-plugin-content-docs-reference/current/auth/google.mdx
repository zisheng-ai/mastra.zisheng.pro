...
## MastraAuthGoogle 类 {/* #mastraauthgoogle-class */}
...
<PropertiesTable
  ...
  },
  {
    name: 'redirectUri',
    type: 'string',
    description: 'SSO callback 的 OAuth redirect URI。必须与 Google Cloud OAuth client 中配置的 redirect URI 一致。',
    isOptional: true,
  ...
  },
  {
    name: 'hostedDomain',
    type: 'string',
    description: '以 `hd` 形式传递给 Google 的托管域登录提示。该值仅用作提示，不用于授权。',
    isOptional: true,
...
## MastraRBACGoogle 类 {/* #mastrarbacgoogle-class */}
