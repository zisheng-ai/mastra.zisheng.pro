...
<PropertiesTable
  content={[
  {
    name: 'domain',
    type: 'string',
    description: '你的 Auth0 domain（例如 your-tenant.auth0.com），用于验证 Auth0 tenant 签发的 JWT token。',
    isOptional: true,
...
<PropertiesTable
  ...
  },
  {
    name: 'AUTH0_AUDIENCE',
    type: 'string',
    description: '你的 Auth0 API 标识符，即在 Auth0 Dashboard 中创建 API 时设置的标识符。',
    isOptional: true,
  },
]}
/>
