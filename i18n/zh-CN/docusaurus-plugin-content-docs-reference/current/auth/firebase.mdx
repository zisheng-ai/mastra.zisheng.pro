...
<PropertiesTable
  content={[
  {
    name: 'serviceAccount',
    type: 'string',
    description: 'Firebase 服务账号 JSON 文件的路径。该文件包含在服务端验证 Firebase ID token 所需的凭据。',
    isOptional: true,
...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'string',
    description: 'Firestore 数据库 ID 的备用环境变量。未设置 FIRESTORE_DATABASE_ID 时使用。',
    isOptional: true,
  },
]}
/>
...
## Firebase 用户类型 {/* #firebase-user-type */}
