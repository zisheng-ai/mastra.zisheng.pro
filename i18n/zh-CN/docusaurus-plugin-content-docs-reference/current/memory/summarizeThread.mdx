...
<PropertiesTable
  ...
  },
  {
    name: 'resourceId',
    type: 'string',
    description: '拥有该 thread 的 resource ID。如果提供，则验证 thread 所有权。该值也会传给 Extractor 上下文。',
    isOptional: true,
  },
  {
    name: 'lastMessages',
    type: 'number',
    description: '仅汇总 thread 的最后 N 条消息。默认加载整个 thread，但受 `maxInputTokens` 限制。',
    isOptional: true,
  },
  {
    name: 'maxInputTokens',
    type: 'number',
    description: '当收集的消息超过此估算 token 数量时，停止加载更早的消息。最新消息始终会包含在内。',
    isOptional: true,
