...
## 如何选择 Scorer {/* #choosing-between-scorers */}
...
## 基于代码的 Tool Call Accuracy Scorer {/* #code-based-tool-call-accuracy-scorer */}
...
### 基于代码的 Scorer 选项 {/* #code-based-scorer-options */}
...
### 正确选择 Tool {/* #correct-tool-selection */}
...
### Tool 顺序验证 {/* #tool-order-validation */}
...
## 基于 LLM 的 Tool Call Accuracy Scorer {/* #llm-based-tool-call-accuracy-scorer */}
...
## 基于 LLM 的 Scorer 示例 {/* #llm-based-scorer-examples */}

基于 LLM 的 Scorer 使用 AI 评估 Tool 选择是否适合用户请求。

### 基本 LLM 评估 {/* #basic-llm-evaluation */}
...
### 处理不恰当的 Tool 使用 {/* #handling-inappropriate-tool-usage */}
...
### 评估澄清请求 {/* #evaluating-clarification-requests */}
...
## 比较两种 Scorer {/* #comparing-both-scorers */}
