...
## 数据集驱动的测试 {/* #dataset-driven-testing */}
...
<PropertiesTable
  content={[
  {
    name: 'score',
    type: 'number',
    description: '介于 0 和 scale 之间的召回率得分（默认 0-1），表示上下文覆盖的 ground-truth 论断比例',
  },
  {
    name: 'reason',
    type: 'string',
...
### 动态上下文提取 {/* #dynamic-context-extraction */}
...
### 静态上下文评估 {/* #static-context-evaluation */}
...
## 与 Context Precision 的比较 {/* #comparison-with-context-precision */}
