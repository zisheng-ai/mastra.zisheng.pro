...
### Scorer 配置 {/* #scorer-configuration */}
...
#### Both 模式（'both'——默认） {/* #both-mode-both---default */}
...
### 代码生成评估 {/* #code-generation-evaluation */}
...
### 指令遵循评估 {/* #instruction-following-assessment */}
...
### 内容格式验证 {/* #content-format-validation */}
...
### Agent 响应质量 {/* #agent-response-quality */}
...
### Multi-Agent 系统评估 {/* #multi-agent-system-evaluation */}
...
### 特定格式评估 {/* #format-specific-evaluation */}
...
### 出色的对齐示例 {/* #excellent-alignment-example */}
...
### 出色的对齐输出 {/* #excellent-alignment-output */}
...
### 部分对齐示例 {/* #partial-alignment-example */}
...
#### 部分对齐输出 {/* #partial-alignment-output */}
...
### 对齐较差的示例 {/* #poor-alignment-example */}
...
### 评估模式示例 {/* #evaluation-mode-examples */}

#### User 模式——仅关注用户 prompt {/* #user-mode---focus-on-user-prompt-only */}
...
#### System 模式——仅关注 system 指南 {/* #system-mode---focus-on-system-guidelines-only */}
...
#### Both 模式——组合评估（默认） {/* #both-mode---combined-evaluation-default */}
...
## 与其他 Scorer 的比较 {/* #comparison-with-other-scorers */}
