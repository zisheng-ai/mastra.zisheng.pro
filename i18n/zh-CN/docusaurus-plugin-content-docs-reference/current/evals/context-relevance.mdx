...
## 内容生成评估 {/* #content-generation-evaluation */}
...
## 上下文选择优化 {/* #context-selection-optimization */}
...
### 加权相关性评分 {/* #weighted-relevance-scoring */}
...
### 与 Context Precision 的区别 {/* #difference-from-context-precision */}
...
### 自定义扣分配置 {/* #custom-penalty-configuration */}
...
### 动态提取上下文 {/* #dynamic-context-extraction */}
...
### 组合多个上下文来源 {/* #combining-multiple-context-sources */}
...
### 混合相关性示例 {/* #mixed-relevance-example */}
...
### 动态提取上下文 {/* #dynamic-context-extraction-1 */}
...
### RAG 系统集成 {/* #rag-system-integration */}
...
## 与 Context Precision 比较 {/* #comparison-with-context-precision */}
