...
## RAG 系统评估 {/* #rag-system-evaluation */}
...
### 平均精度均值（MAP） {/* #mean-average-precision-map */}
...
### 大规模上下文评估 {/* #large-context-evaluation */}
...
## 与 Context Relevance 的比较 {/* #comparison-with-context-relevance */}
