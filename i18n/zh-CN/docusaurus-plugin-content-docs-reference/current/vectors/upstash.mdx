...
### 高级混合搜索选项 {/* #advanced-hybrid-search-options */}
...
### 更新混合 Vector {/* #updating-hybrid-vectors */}
...
### 使用 fastembed 生成本地嵌入 {/* #local-embeddings-with-fastembed */}
