...
<PropertiesTable
  ...
  { name: 'host', type: 'string', description: 'DSQL 集群端点（例如 abc123.dsql.us-east-1.on.aws）', isOptional: false },
  { name: 'pool', type: 'pg.Pool', description: '预配置的 pg.Pool 实例。使用它可直接控制连接池。不能与 host 配置一起使用。', isOptional: true },
  { name: 'user', type: 'string', description: "数据库用户。Aurora DSQL 的管理员角色为 'admin'。", isOptional: true, default: "'admin'" },
  { name: 'database', type: 'string', description: "数据库名称。Aurora DSQL 为每个集群提供一个名为 'postgres' 的数据库。", isOptional: true, default: "'postgres'" },
  { name: 'region', type: 'string', description: 'AWS 区域。未提供时会从 host 提取。', isOptional: true },
  { name: 'schemaName', type: 'string', description: '创建 Mastra 表和索引的 PostgreSQL schema 名称。', isOptional: true, default: "'public'" },
  { name: 'customCredentialsProvider', type: 'AwsCredentialIdentityProvider', description: '用于 IAM 身份验证的自定义 AWS 凭据提供程序。', isOptional: true },
  ...
  { name: 'idleTimeoutMillis', type: 'number', description: '经过这么多毫秒后关闭空闲连接。', isOptional: true, default: '600000' },
  { name: 'maxLifetimeSeconds', type: 'number', description: "最大连接生命周期（秒）。由于 Aurora DSQL 的连接上限为 60 分钟，该值必须小于 3600。", isOptional: true, default: '3300' },
  { name: 'connectionTimeoutMillis', type: 'number', description: '获取连接的超时时间（毫秒）。', isOptional: true, default: '5000' },
  { name: 'allowExitOnIdle', type: 'boolean', description: '所有连接均空闲时允许进程退出。', isOptional: true, default: 'true' },
]}
/>
...
<PropertiesTable content={[
  ...
  { name: 'columns', type: 'string[]', description: '列名数组。为兼容 Aurora DSQL，会自动移除 ASC/DESC 修饰符。', isOptional: false },
  { name: 'unique', type: 'boolean', description: '创建唯一索引。', isOptional: true, default: 'false' },
  { name: 'concurrent', type: 'boolean', description: '在 Aurora DSQL 中会被忽略。索引始终异步创建。', isOptional: true },
  ...
  { name: 'tablespace', type: 'string', description: '在 Aurora DSQL 中会被忽略。不支持 tablespace。', isOptional: true },
]}/>
