...
### 使用 default storage {/* #with-a-default-storage */}
...
### 为不同工作负载使用独立数据库 {/* #separate-databases-for-different-workloads */}
...
### 用于 observability 的专用存储 {/* #specialized-storage-for-observability */}
...
### 面向多副本集群的 Replicated ClickHouse {/* #replicated-clickhouse-for-multi-replica-clusters */}
