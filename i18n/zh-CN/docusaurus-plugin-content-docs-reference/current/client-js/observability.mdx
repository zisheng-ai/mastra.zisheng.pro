...
## 获取特定 Trace {/* #getting-a-specific-trace */}
...
## 筛选并获取 Trace {/* #getting-traces-with-filtering */}
...
## 为列表视图列出 Trace {/* #listing-traces-for-a-list-view */}
...
## 按 span 获取评分 {/* #getting-scores-by-span */}
...
### 按时间查询反馈 {/* #querying-feedback-over-time */}
...
### 查询反馈百分位数 {/* #querying-feedback-percentiles */}
