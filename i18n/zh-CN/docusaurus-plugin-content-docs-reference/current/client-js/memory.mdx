...
## 创建新 thread {/* #create-a-new-thread */}
...
### 获取 thread 详情 {/* #get-thread-details */}
...
### 检索 thread 消息 {/* #retrieve-thread-messages */}
...
### 获取 Working memory {/* #get-working-memory */}
...
### 获取 Memory 状态 {/* #get-memory-status */}
