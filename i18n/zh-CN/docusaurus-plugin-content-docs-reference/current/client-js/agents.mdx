...
#### AI SDK 兼容格式 {/* #ai-sdk-compatible-format */}
...
### 为模型调整 Client Tool 输出结构 {/* #shape-client-tool-output-for-the-model */}
...
### 追踪 Client Tool {/* #tracing-client-tools */}
...
## 存储 Agent 的方法 {/* #stored-agent-methods */}
...
### 获取特定版本的 Agent {/* #getting-an-agent-with-a-specific-version */}
