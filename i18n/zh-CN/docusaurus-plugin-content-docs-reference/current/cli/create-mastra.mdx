...
## 冲突与验证 {/* #conflicts-and-validation */}
...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'string',
    description: '自动设置 Provider 成功后，将所选 Provider 的 API key 写入生成的 .env 文件。',
    isOptional: true,
  },
  {
    name: '--no-skills',
