...
<PropertiesTable
  content={[
  {
    name: 'rules',
    type: 'RegexRule[]',
    description: '要应用的自定义正则表达式规则。每条规则都有名称、正则表达式模式和可选的替换字符串。',
    isOptional: true,
    properties: [
      {
        type: 'RegexRule',
  ...
  },
  {
    ...
    description: "应用过滤器的阶段。'input' 过滤输入消息。'output' 过滤输出流和结果。'all' 同时过滤两者。",
    isOptional: true,
    defaultValue: "'all'",
  },
  {
    ...
    type: 'boolean',
    description: '在每个报告条目中包含被遮盖的文本。默认关闭，因为这些值正是 Processor 要移除的数据。',
    isOptional: true,
    defaultValue: 'false',
  },
  {
...
<PropertiesTable
  ...
  },
  {
    ...
    description: '依据所有已配置规则检查输入消息。根据策略进行阻止、遮盖或警告。phase 为 output 时跳过。',
    isOptional: false,
  },
  {
  ...
  },
  {
    ...
    description: '依据所有已配置规则检查输出消息。根据策略进行阻止、遮盖或警告。phase 为 input 时跳过。',
    isOptional: false,
  },
]}
/>
...
<PropertiesTable
  ...
  },
  {
    name: 'partIndex',
    type: 'number',
    description: '被遮盖部分在消息 parts 数组中的索引，该数组还包含非文本部分。字符串内容和流数据块没有此项。',
    isOptional: true,
  },
  {
    name: 'redactions',
