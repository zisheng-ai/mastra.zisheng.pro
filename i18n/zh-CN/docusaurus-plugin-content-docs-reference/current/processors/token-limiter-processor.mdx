...
### 用作输入 Processor（限制上下文窗口） {/* #as-an-input-processor-limit-context-window */}
...
### 用作逐步骤输入 Processor（限制多步骤 token 增长） {/* #as-a-per-step-input-processor-limit-multi-step-token-growth */}
...
### 用作输出 Processor（限制响应长度） {/* #as-an-output-processor-limit-response-length */}
