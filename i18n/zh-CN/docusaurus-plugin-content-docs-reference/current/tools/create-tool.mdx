...
## 使用严格 Tool 输入的范例 {/* #example-with-strict-tool-inputs */}
...
## 使用 `toModelOutput` 的范例 {/* #example-with-tomodeloutput */}
...
## 使用 `transform` 的范例 {/* #example-with-transform */}
...
## 使用 MCP annotation 的范例 {/* #example-with-mcp-annotations */}
...
## Tool lifecycle hook（生命周期钩子） {/* #tool-lifecycle-hooks */}
...
### Hook 运行顺序 {/* #hook-execution-order */}
...
## MCP Tool annotation（注解） {/* #mcp-tool-annotations */}
...
### `ToolAnnotations` 属性 {/* #toolannotations-properties */}
