...
<PropertiesTable
  ...
  },
  {
    name: 'timestamp',
    type: 'Date',
    description: '记录分数的时间。Exporter 接收 Date 对象，该对象通过 JSON 序列化为 ISO 8601 字符串。',
    required: true,
  },
  {
    name: 'traceId',
  ...
  },
  {
    name: 'scoreSource',
    type: 'string',
    description: '用于标识分数生成方式的自由格式字符串。常见值包括 manual、automated 和 experiment。',
  },
  {
    name: 'score',
    type: 'number',
