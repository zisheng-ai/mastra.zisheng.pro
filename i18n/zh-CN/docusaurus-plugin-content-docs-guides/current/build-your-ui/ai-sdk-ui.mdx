...
### 渲染 Tool 输出 {/* #rendering-tool-outputs */}
...
### 渲染 Workflow 数据 {/* #rendering-workflow-data */}
...
### 加载历史消息 {/* #loading-historical-messages */}
...
### 传递额外数据 {/* #passing-additional-data */}
...
### 经用户批准后暂停或恢复 Workflow {/* #workflow-suspendresume-with-user-approval */}
...
### Tool 中的嵌套 Agent 流 {/* #nested-agent-streams-in-tools */}
...
### 从 Workflow 步骤流式传输 Agent 文本 {/* #streaming-agent-text-from-workflow-steps */}
...
### 分支 Workflow 的多阶段进度 {/* #multi-stage-progress-with-branching-workflows */}
...
### Agent 网络中的进度指示器 {/* #progress-indicators-in-agent-networks */}
