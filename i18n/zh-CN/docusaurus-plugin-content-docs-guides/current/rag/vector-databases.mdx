...
### 数据库命名规则 {/* #naming-rules-for-databases */}
...
### Upsert 嵌入 {/* #upserting-embeddings */}
...
### 按 Metadata 过滤器删除 {/* #delete-by-metadata-filter */}
...
### 删除多个文档 {/* #delete-multiple-documents */}
...
### 按向量 ID 删除 {/* #delete-by-vector-ids */}
