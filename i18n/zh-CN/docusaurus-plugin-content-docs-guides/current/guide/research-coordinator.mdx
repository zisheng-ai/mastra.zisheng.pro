...
## 创建研究 Agent {/* #create-the-research-agent */}
...
## 创建写作 Agent {/* #create-the-writing-agent */}
...
## 创建 supervisor Agent {/* #create-the-supervisor-agent */}
...
## 测试基本 supervisor {/* #test-the-basic-supervisor */}
...
## 测试研究协调器 {/* #test-the-research-coordinator */}
