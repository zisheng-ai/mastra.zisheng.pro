...
## 安装终端依赖项 {/* #install-the-terminal-dependencies */}
...
## 创建 Coding Agent {/* #create-the-coding-agent */}
...
## 注册 Coding Agent {/* #register-the-coding-agent */}
...
## 测试 Coding Agent {/* #test-the-coding-agent */}
...
## 创建 Agent controller {/* #create-the-agent-controller */}
...
## 运行 Coding Agent {/* #run-the-coding-agent */}
