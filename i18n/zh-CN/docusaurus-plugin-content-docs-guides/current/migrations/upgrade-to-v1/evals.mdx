...
### `getScorers` 改为 `listScorers` {/* #getscorers-to-listscorers */}
...
### `runExperiment` 改为 `runEvals` {/* #runexperiment-to-runevals */}
...
### `getScorerByName` 改为 `getScorerById` {/* #getscorerbyname-to-getscorerbyid */}
...
### scorer 配置从 `name` 改为 `id` {/* #scorer-configuration-from-name-to-id */}
...
### Storage 评分 API 改为 `listScoresBy*` 模式 {/* #storage-score-apis-to-listscoresby-pattern */}
...
### 预构建 scorer 改为从 `scorers/prebuilt` 路径导入 {/* #prebuilt-scorer-imports-to-scorersprebuilt-path */}
...
### scorer 消息类型从 `UIMessage` 改为 `MastraDBMessage` {/* #scorer-message-types-from-uimessage-to-mastradbmessage */}
...
### 消息内容结构改为嵌套格式 {/* #message-content-structure-to-nested-format */}
...
### Agent 的 `TMetrics` 泛型参数 {/* #agent-tmetrics-generic-parameter */}
...
### Evals 相关类型导出 {/* #evals-related-type-exports */}
...
### `createUIMessage` 测试辅助函数 {/* #createuimessage-test-helper */}
