...
### 第 1 步：OpenTelemetry 埋点 {/* #step-1-opentelemetry-instrumentation */}
...
### 转发日志（可选） {/* #forwarding-logs-optional */}
...
## 多服务分布式 Tracing {/* #multi-service-distributed-tracing */}
