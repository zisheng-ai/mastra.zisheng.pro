...
## 何时使用 bridge {/* #when-to-use-the-bridge */}
...
## Trace 与日志关联 {/* #trace-and-log-correlation */}
...
### 第 1 步：初始化 dd-trace {/* #step-1-initialize-dd-trace */}
...
### 第 2 步：Mastra 配置 {/* #step-2-mastra-configuration */}
...
## Agent 模式与 agentless 模式 {/* #agent-vs-agentless-mode */}
...
## 将上下文键提升为扁平标签 {/* #promoting-context-keys-to-flat-tags */}
