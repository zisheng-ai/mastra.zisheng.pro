...
## 脱敏样式 {/* #redaction-styles */}

过滤器支持两种脱敏样式：

### 完全脱敏（默认） {/* #full-redaction-default */}
...
### 医疗保健应用 {/* #healthcare-applications */}
