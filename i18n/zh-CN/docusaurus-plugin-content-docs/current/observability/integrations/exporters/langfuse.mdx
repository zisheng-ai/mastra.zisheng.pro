...
### 实时模式与批处理模式 {/* #realtime-vs-batch-mode */}

Langfuse exporter 支持两种 Trace 发送模式：

#### 实时模式（开发） {/* #realtime-mode-development */}
...
#### 批处理模式（生产） {/* #batch-mode-production */}
...
#### 为高流量 Trace 调整批处理 {/* #batch-tuning-for-high-volume-traces */}
...
## 按 Agent 限定 evaluator {/* #scoping-evaluators-per-agent */}
...
## 自定义 Trace 元数据 {/* #custom-trace-metadata */}
...
### Prompt 对象字段 {/* #prompt-object-fields */}
