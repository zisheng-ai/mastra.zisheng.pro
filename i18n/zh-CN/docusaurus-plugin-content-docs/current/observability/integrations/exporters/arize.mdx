...
### 批处理选项 {/* #batch-processing-options */}
...
### Resource 属性 {/* #resource-attributes */}
...
## OpenInference 语义约定 {/* #openinference-semantic-conventions */}
