...
## 何时使用 AgentController {/* #when-to-use-the-agentcontroller */}
...
## 理解运行时模型 {/* #understand-the-runtime-model */}
...
## Session 和线程 {/* #sessions-and-threads */}
...
## 切换模式和模型 {/* #switch-modes-and-models */}
...
## 管理线程和状态 {/* #manage-threads-and-state */}
...
## 批准 Tool 并恢复暂停 {/* #approve-tools-and-resume-suspensions */}
...
## 委派给子 Agent {/* #delegate-to-subagents */}
...
## 连接聊天 Channel {/* #connect-chat-channels */}
