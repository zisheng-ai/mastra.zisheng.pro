...
## 何时使用 Editor {/* #when-to-use-editor */}
...
## 决定协作者可以编辑哪些内容 {/* #decide-what-collaborators-can-edit */}
...
## 选择变更的存储位置 {/* #choose-where-changes-are-stored */}

Editor 可以将变更保存在配置的数据库中，也可以作为文件保存在仓库中。

### 数据库 Storage {/* #database-storage */}
