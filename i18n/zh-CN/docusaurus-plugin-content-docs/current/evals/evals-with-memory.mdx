...
## 如何选择使用方式 {/* #when-to-use-which-approach */}
...
## 使用 `runEvals` 共享 thread {/* #shared-thread-with-runevals */}
...
## 使用 `runEvals` 为每个项目创建 thread {/* #per-item-threads-with-runevals */}
...
## 使用内联任务运行 Dataset 实验 {/* #dataset-experiments-with-an-inline-task */}
