...
## 何时使用多轮 Evals {/* #when-to-use-multi-turn-evals */}
...
## 跨轮次召回需要 Memory {/* #memory-is-required-for-cross-turn-recall */}
...
## 使用 `turns` 进行逐轮断言 {/* #per-turn-assertions-with-turns */}
...
## 与 Gate 和阈值结合 {/* #combining-with-gates-and-thresholds */}
...
## 混合单轮和多轮 {/* #mixing-single-turn-and-multi-turn */}
