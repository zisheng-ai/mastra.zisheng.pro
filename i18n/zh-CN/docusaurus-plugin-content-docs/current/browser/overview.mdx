...
## 何时使用 Browser {/* #when-to-use-browser */}
...
### Firecrawl Browser Sandbox（FirecrawlBrowser 原生支持） {/* #firecrawl-browser-sandbox-firecrawlbrowser-native */}
...
### Browserbase（Stagehand 原生支持） {/* #browserbase-stagehand-native */}
