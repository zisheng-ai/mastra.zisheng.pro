...
## 何时使用 Processor {/* #when-to-use-processors */}
...
### 启用 Memory 时 {/* #with-memory-enabled */}
...
## 将 Processor 附加到 Agent {/* #attach-processors-to-an-agent */}
...
### 按调用覆盖 Processor {/* #override-processors-per-call */}
...
## 创建自定义 Processor {/* #create-custom-processors */}
...
### 转换输入消息 {/* #transform-input-messages */}
...
### 在调用 Provider 前重写 LLM 请求 {/* #rewrite-the-llm-request-before-the-provider-call */}
...
### 调用 Provider 后处理 LLM 响应 {/* #act-on-the-llm-response-after-the-provider-call */}
...
### 使用 `prepareStep()` 回调 {/* #use-the-preparestep-callback */}
...
### 转换输出消息 {/* #transform-output-messages */}
...
### 跨块和步骤持久化数据 {/* #persist-data-across-chunks-and-steps */}
...
## 内置实用 Processor {/* #built-in-utility-processors */}
...
### 何时使用响应缓存 {/* #when-to-use-response-caching */}
...
### 通过 RequestContext 按调用覆盖 {/* #per-call-overrides-via-requestcontext */}
...
### 缓存的实现方式 {/* #how-caching-is-implemented */}
...
### 缓存键包含的内容 {/* #whats-in-the-cache-key */}
...
#### 自定义缓存键 {/* #customize-the-cache-key */}
...
### 使用 `maxSteps` 确保最终响应 {/* #ensure-a-final-response-with-maxsteps */}
...
### 传递提醒但不保留 {/* #deliver-a-reminder-without-retaining-it */}
...
### 发出自定义流事件 {/* #emit-custom-stream-events */}
...
### 向消息添加元数据 {/* #add-metadata-to-messages */}
...
### 将 Workflow 用作 Processor {/* #use-workflows-as-processors */}
...
### 错误 Processor 重试限制 {/* #error-processor-retry-limits */}
...
### 中止和 tripwire 块 {/* #abort-and-tripwire-chunks */}
