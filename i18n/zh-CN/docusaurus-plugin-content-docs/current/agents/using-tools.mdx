...
## 将 Agent 用作 Tool {/* #agents-as-tools */}
...
## 将 Workflow 用作 Tool {/* #workflows-as-tools */}
...
## 在多个 Agent 之间共享 Tool {/* #share-tools-across-agents */}
...
## 为模型调整输出形状 {/* #shape-output-for-the-model */}
...
## 为 UI 和对话记录转换 Tool payload {/* #transform-tool-payloads-for-ui-and-transcripts */}
...
## 在 Tool 调用前后运行逻辑 {/* #run-logic-around-tool-calls */}
...
### 每次执行的 hook {/* #per-execution-hooks */}
...
### 示例：使用 `onInputAvailable` 和 `onOutput` {/* #example-using-oninputavailable-and-onoutput */}
...
### 在 UI 中流式传输 Tool 输入 {/* #streaming-tool-input-in-uis */}
...
## 控制 Tool 选择 {/* #control-tool-selection */}
...
## 控制流响应中的 `toolName` {/* #control-toolname-in-stream-responses */}
...
### 将子 Agent 和 Workflow 用作 Tool {/* #subagents-and-workflows-as-tools */}
...
### 使用 Provider 网页搜索 {/* #use-provider-web-search */}
...
### 提交计划以供审查 {/* #submit-a-plan-for-review */}
