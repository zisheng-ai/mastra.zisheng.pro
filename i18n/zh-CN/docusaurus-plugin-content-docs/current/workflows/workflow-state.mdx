...
## 状态与步骤输入/输出 {/* #state-vs-step-inputoutput */}
...
## 定义状态 Schema {/* #defining-state-schemas */}
...
## 状态跨挂起/恢复持久化 {/* #state-persistence-across-suspendresume */}
...
## 嵌套 Workflow 中的状态 {/* #state-in-nested-workflows */}
