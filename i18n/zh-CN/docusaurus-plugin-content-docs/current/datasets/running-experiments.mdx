...
## 实验目标 {/* #experiment-targets */}

可以将实验指向已注册的 Agent、Workflow 或 Scorer。

### 已注册的 Agent {/* #registered-agent */}
...
#### 启用了 Memory 的 Agent {/* #memory-enabled-agents */}
...
### 已注册的 Workflow {/* #registered-workflow */}
...
## 控制每次运行的持久化 {/* #control-persistence-per-run */}
...
## 观察实验事件 {/* #observe-experiment-events */}
...
### 阻止未声明的 Tool {/* #block-undeclared-tools */}
...
### 匹配与消耗 {/* #matching-and-consumption */}
...
### 固定 Dataset 版本 {/* #pinning-a-dataset-version */}
...
## 理解 summary {/* #understanding-the-summary */}
