...
description: "Documentation de the GCSFilesystem provider for Google Cloud Storage."
packages:
  - "@mastra/gcs"
---
...
Renvoie the mount configuration for sandboxes that support mounting this filesystem type.
