...
Renvoie file or directory metadata.
...
Renvoie the canonical path from Mesa.
...
Méthodes expect absolute paths. For `MesaFilesystem`, paths are rooted at the Mesa mount and must include the org slug and repo name:
