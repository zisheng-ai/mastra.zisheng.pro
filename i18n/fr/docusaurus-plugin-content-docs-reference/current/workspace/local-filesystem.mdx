...
description: "Documentation de the LocalFilesystem provider for local disk storage."
packages:
  - "@mastra/core"
---
...
Renvoie a description of how paths work in this filesystem. When assigned to an agent, this is injected into the agent's system message.
