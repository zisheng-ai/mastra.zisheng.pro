...
description: "Documentation de the AzureBlobFilesystem provider for Azure Blob Storage."
packages:
  - "@mastra/azure"
---
...
Renvoie the underlying Azure Blob Storage `ContainerClient`.
...
Renvoie the mount configuration for sandbox providers that support Azure Blob filesystem mounts.
