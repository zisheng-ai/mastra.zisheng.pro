...
description: "Documentation de the connect() method available in real-time voice providers, which establishes a connection for speech-to-speech communication."
packages:
  - "@mastra/core"
  - "@mastra/node-speaker"
...
Renvoie a `Promise<void>` that resolves when the connection is successfully established.
