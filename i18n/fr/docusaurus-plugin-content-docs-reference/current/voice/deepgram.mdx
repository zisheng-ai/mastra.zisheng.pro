...
description: "Documentation de the Deepgram voice implementation, providing text-to-speech and speech-to-text capabilities with multiple voice models and languages."
packages:
...
Renvoie a list of available voice options.
