---
title: "Référence : Google Gemini Live voice | Voice"
description: "Documentation de the GeminiLiveVoice class, providing real-time multimodal voice interactions using Google's Gemini Live API with support for both Gemini API and Vertex AI."
packages:
  - "@mastra/node-audio"
...
Renvoie a list of available voice speakers for the Gemini Live API.
