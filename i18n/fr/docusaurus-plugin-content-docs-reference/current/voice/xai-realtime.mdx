---
title: "Référence : xAI Realtime voice | Voice"
description: "Documentation de the XAIRealtimeVoice class, providing realtime voice conversations with the xAI Grok Voice Agent API."
packages:
  - "@mastra/node-audio"
