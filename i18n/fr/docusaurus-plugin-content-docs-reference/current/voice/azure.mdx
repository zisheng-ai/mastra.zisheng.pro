...
description: "Documentation de the AzureVoice class, providing text-to-speech and speech-to-text capabilities using Azure Cognitive Services."
packages:
  - "@mastra/voice-azure"
---
...
Renvoie an array of available voice options (200+ voices), where each node contains:
