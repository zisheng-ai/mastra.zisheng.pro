---
title: "Référence : Inworld Realtime voice | Voice"
description: "Documentation de the InworldRealtimeVoice class, providing real-time speech-to-speech, tool calling, and Inworld-specific session controls via WebSockets."
packages:
  - "@mastra/node-audio"
...
Renvoie the curated voice list bundled with the package. Inworld's catalog is larger than this list; any voice ID can be passed to `speaker` at runtime.
