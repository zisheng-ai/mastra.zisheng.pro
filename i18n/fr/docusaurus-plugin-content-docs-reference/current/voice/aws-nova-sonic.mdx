---
title: "Référence : AWS Nova Sonic voice | Voice"
description: "Documentation de the NovaSonicVoice class, providing real-time speech-to-speech capabilities via AWS Bedrock Nova 2 Sonic."
packages:
  - "@mastra/node-audio"
...
Renvoie the list of voices supported by Nova 2 Sonic.
...
Renvoie whether the voice instance currently holds an open stream.
