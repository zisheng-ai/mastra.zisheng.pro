---
title: "Référence : OpenAI Realtime voice | Voice"
description: "Documentation de the OpenAIRealtimeVoice class, providing real-time text-to-speech and speech-to-text capabilities via WebSockets."
packages:
  - "@mastra/node-audio"
...
Renvoie a list of available voice speakers.
