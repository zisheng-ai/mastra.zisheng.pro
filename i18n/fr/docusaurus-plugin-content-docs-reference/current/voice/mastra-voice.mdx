...
description: "Documentation de the MastraVoice abstract base class, which defines the core interface for all voice services in Mastra, including speech-to-speech capabilities."
packages:
  - "@mastra/core"
---
...
- Renvoie a stream of audio data that can be played or saved
...
Renvoie a list of available voices supported by the provider.
...
- Renvoie a Promise that resolves when the connection is established
