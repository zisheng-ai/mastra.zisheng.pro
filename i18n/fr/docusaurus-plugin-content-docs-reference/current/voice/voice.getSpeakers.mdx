---
title: "Référence : voice.getSpeakers() | Voice Providers"
description: "Documentation de the getSpeakers() method available in voice providers, which retrieves available voice options."
packages:
...
## Métadonnées spécifiques au fournisseur
