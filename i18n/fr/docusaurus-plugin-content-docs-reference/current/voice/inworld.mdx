...
description: "Documentation de the InworldVoice class, providing streaming text-to-speech and batch speech-to-text capabilities using Inworld AI."
packages:
...
Converts text to speech using Inworld's streaming TTS endpoint. Renvoie a readable stream that emits audio chunks progressively as they arrive.
...
Renvoie a list of available voices from the Inworld API.
