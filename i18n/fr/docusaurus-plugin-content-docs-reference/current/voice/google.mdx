---
title: "Référence : Google | Voice"
description: "Documentation de the Google Voice implementation, providing text-to-speech and speech-to-text capabilities with support for both API key and Vertex AI authentication."
packages:
  - "@mastra/voice-google"
---
    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            type: 'string',
            description:
              "Code de langue de la voix (e.g., 'en-US'). Defaults to the language code derived from the speaker ID, or 'en-US'.",
            isOptional: true,
          },
          {
            name: 'input',
...
Renvoie an array of available voice options, where each node contains:
