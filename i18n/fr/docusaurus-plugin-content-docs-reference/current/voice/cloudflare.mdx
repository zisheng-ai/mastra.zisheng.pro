...
description: "Documentation de the CloudflareVoice class, providing text-to-speech capabilities using Cloudflare Workers AI."
packages:
...
- Jetons d’API can be provided via constructor options or environment variables (CLOUDFLARE\_API\_TOKEN and CLOUDFLARE\_ACCOUNT\_ID)
