...
description: "Documentation de the speak() method available in all Mastra voice providers, which converts text to speech."
packages:
  - "@mastra/core"
  - "@mastra/node-speaker"
  - "@mastra/voice-openai"
...
Renvoie a `Promise<NodeJS.ReadableStream | void>` where:
