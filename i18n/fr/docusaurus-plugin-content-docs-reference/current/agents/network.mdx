...
description: "Documentation de la méthode `Agent.network()` des Agents Mastra, qui permet la collaboration et le routage entre plusieurs Agents."
packages:
  - "@mastra/core"
---
    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            type: 'object',
            isOptional: true,
            description: 'Configuration de la mémoire. Il s’agit de la méthode recommandée pour la gérer.',
            properties: [
              {
                type: 'object',
                parameters: [
                ...
                parameters: [
                  {
                    ...
                    type: 'MemoryConfig',
                    isOptional: true,
                    description: 'Configuration du comportement de la mémoire, notamment l’historique des messages et le rappel sémantique.',
                  },
                ],
              },
            ],
          ...
          },
          {
            ...
            isOptional: true,
            description: 'Fonction de rappel déclenchée lorsqu’une erreur survient pendant l’exécution d’un sous-Agent.',
          },
        ],
      },
    ],
...
<PropertiesTable
  ...
  },
  {
    ...
    description: 'Promesse qui se résout avec l’état actuel d’exécution du Workflow',
  },
  {
    name: 'result',
    type: 'Promise<WorkflowResult<TState, TOutput, TSteps>>',
    description: 'Promesse qui se résout avec le résultat final du Workflow',
  },
  {
    name: 'usage',
    type: 'Promise<{ promptTokens: number; completionTokens: number; totalTokens: number }>',
    description: 'Promesse qui se résout avec les statistiques d’utilisation des tokens',
  },
  {
    name: 'object',
...
### Diffusion d’objets partiels {/* #streaming-partial-objects */}
