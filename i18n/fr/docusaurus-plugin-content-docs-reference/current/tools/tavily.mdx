---
title: "Référence : Tavily tools | Tools and MCP"
...
Renvoie an object containing all four tools with a shared configuration.
...
Creates a tool that searches the web using Tavily. Renvoie relevant results with content snippets, optional AI-generated answers, and images.
...
Creates a tool that extracts content from one or more URLs. Renvoie raw page content in markdown or text format with up to 20 URLs per request.
