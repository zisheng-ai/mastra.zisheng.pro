---
title: "Référence : Bright Data tools | Tools and MCP"
...
Renvoie an object containing both tools with a shared configuration.
...
Creates a tool that searches Google through Bright Data's SERP API. Renvoie parsed organic results.
