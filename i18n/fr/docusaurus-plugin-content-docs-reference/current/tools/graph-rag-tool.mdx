---
title: "Référence : createGraphRAGTool() | Tools and MCP"
description: Documentation de the GraphRAG Tool in Mastra, which enhances RAG by building a graph of semantic relationships between documents.
packages:
  - "@mastra/core"
  - "@mastra/rag"
---
