---
title: "Référence : createBedrockKBTool() | Tools and MCP"
description: Documentation de the Bedrock Knowledge Base Tool in Mastra, which retrieves documents from Amazon Bedrock Knowledge Bases with agentic retrieval support.
packages:
  - "@mastra/core"
  - "@mastra/rag"
---
