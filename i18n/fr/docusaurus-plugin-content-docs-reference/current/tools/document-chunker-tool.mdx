---
title: "Référence : createDocumentChunkerTool() | Tools and MCP"
description: Documentation de the Document Chunker Tool in Mastra, which splits documents into smaller chunks for efficient processing and retrieval.
packages:
  - "@mastra/rag"
---
