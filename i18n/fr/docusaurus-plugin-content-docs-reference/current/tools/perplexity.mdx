---
title: "Référence : Perplexity tools | Tools and MCP"
...
Renvoie an object containing all Perplexity tools that share the supplied configuration.
...
Creates a tool that searches the web using the Perplexity Search API. Renvoie ranked results with titles, URLs, snippets, and optional publication dates.
