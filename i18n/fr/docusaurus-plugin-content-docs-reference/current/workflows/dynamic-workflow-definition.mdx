...
## Champs de définition {/* #definition-fields */}
...
## Entrées de graphe {/* #graph-entries */}
...
### Étapes de mapping {/* #mapping-steps */}
...
### Étapes de Workflow imbriqué {/* #nested-workflow-steps */}
...
### Entrées parallel {/* #parallel-entries */}
...
### Entrées conditionnelles {/* #conditional-entries */}
...
### Entrées foreach {/* #foreach-entries */}
...
### Entrées de boucle {/* #loop-entries */}
