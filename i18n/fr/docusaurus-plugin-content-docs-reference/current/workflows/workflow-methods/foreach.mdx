...
### Exécution et attente {/* #execution-and-waiting */}
...
### Utiliser `.then()` après `.foreach()` {/* #using-then-after-foreach */}
...
### Utiliser `.map()` après `.foreach()` {/* #using-map-after-foreach */}
...
### Enchaîner plusieurs appels `.foreach()` {/* #chaining-multiple-foreach-calls */}
...
### Événements de progression pendant le streaming {/* #progress-events-during-streaming */}
...
### Reprendre une seule itération {/* #resuming-a-single-iteration */}
