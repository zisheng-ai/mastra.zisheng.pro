...
Renvoie the current observability configuration.
...
Renvoie all configured exporters.
...
Renvoie all configured span output processors.
...
Renvoie the logger instance for exporters and other components.
