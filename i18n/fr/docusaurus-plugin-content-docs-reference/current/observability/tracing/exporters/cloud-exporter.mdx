...
**Renvoie:** `Promise<void>` after the tracing event has been accepted for buffering or ignored.
...
**Renvoie:** `Promise<void>` after the log event has been accepted for buffering.
...
**Renvoie:** `Promise<void>` after the metric event has been accepted for buffering.
...
**Renvoie:** `Promise<void>` after the score event has been accepted for buffering.
...
**Renvoie:** `Promise<void>` after the feedback event has been accepted for buffering.
