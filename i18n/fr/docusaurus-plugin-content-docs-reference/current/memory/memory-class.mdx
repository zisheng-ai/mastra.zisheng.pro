...
To enable `workingMemory` on an agent, you’ll need a storage provider configured on your main Instance Mastra. See [Mastra class](../core/mastra-class) for more information.
