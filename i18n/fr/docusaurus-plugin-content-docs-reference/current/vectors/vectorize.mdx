---
title: "Référence : Cloudflare vector store | Vectors"
description: Documentation de the CloudflareVector class in Mastra, which provides vector search using Cloudflare Vectorize.
packages:
  - "@mastra/vectorize"
---
