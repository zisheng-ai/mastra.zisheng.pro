---
title: "Référence : Pinecone vector store | Vectors"
description: Documentation de the PineconeVector class in Mastra, which provides an interface to Pinecone's vector database.
packages:
  - "@mastra/pinecone"
---
