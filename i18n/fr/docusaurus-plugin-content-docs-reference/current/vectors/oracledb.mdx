---
title: "Référence : OracleDB vector store | Vectors"
description: Documentation de the Oracle Database vector provider in Mastra.
packages:
  - "@mastra/core"
  - "@mastra/fastembed"
  - "@mastra/memory"
...
Renvoie the logical Mastra index names recorded in the Oracle vector registry table.

### `describeIndex()`

Renvoie Oracle index metadata, including the physical table name, dimension, vector count, metric, index type, vector format, and configured accuracy.
