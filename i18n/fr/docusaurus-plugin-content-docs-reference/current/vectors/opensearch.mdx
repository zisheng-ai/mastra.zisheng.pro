---
title: "Référence : OpenSearch vector store | Vectors"
description: Documentation de the OpenSearchVector class in Mastra, which provides vector search using OpenSearch.
packages:
  - "@mastra/opensearch"
---
