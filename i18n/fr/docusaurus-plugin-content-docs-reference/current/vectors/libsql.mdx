---
title: "Référence : libSQL vector store | Vectors"
description: Documentation de the LibSQLVector class in Mastra, which provides vector search using libSQL with vector extensions.
packages:
  - "@mastra/core"
  - "@mastra/fastembed"
  - "@mastra/libsql"
...
<PropertiesTable
  ...
  },
  {
    ...
    defaultValue: 'cosine',
    description:
      'Métrique de distance pour la recherche de similarité. Note: Currently only cosine similarity is supported by libSQL.',
  },
]}
/>
