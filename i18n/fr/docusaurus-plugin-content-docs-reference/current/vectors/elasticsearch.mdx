---
title: "Référence : Elasticsearch vector store | Vectors"
description: Documentation de the ElasticSearchVector class in Mastra, which provides vector search using Elasticsearch.
packages:
