---
title: "Référence : Upstash vector store | Vectors"
description: Documentation de the UpstashVector class in Mastra, which provides vector search using Upstash Vector.
packages:
  - "@mastra/core"
  - "@mastra/fastembed"
  - "@mastra/memory"
...
Renvoie an array of index names (namespaces) as strings.
