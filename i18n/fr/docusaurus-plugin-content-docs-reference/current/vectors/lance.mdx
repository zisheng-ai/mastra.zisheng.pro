---
title: "Référence : Lance vector store | Vectors"
description: "Documentation de the LanceVectorStore class in Mastra, which provides vector search using LanceDB, an embedded vector database based on the Lance columnar format."
packages:
  - "@mastra/lance"
---
...
Renvoie an array of table names as strings.
...
Renvoie the schema of the specified table.
