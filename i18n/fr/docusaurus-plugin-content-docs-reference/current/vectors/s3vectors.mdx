---
title: "Référence : Amazon S3 vectors store | Vectors"
description: Documentation de the S3Vectors class in Mastra, which provides vector search using Amazon S3 Vectors (Preview).
packages:
  - "@mastra/s3vectors"
---
...
Renvoie information about the index.
