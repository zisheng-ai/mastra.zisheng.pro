---
title: "Référence : Astra vector store | Vectors"
description: Documentation de the AstraVector class in Mastra, which provides vector search using DataStax Astra DB.
packages:
  - "@mastra/astra"
---
