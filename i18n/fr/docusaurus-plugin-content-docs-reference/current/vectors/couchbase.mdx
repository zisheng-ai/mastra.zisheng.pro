---
title: "Référence : Couchbase vector store | Vectors"
description: Documentation de the CouchbaseVector class in Mastra, which provides vector search using Couchbase Vector Search.
packages:
  - "@mastra/couchbase"
---
