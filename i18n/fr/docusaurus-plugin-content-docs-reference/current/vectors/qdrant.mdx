---
title: "Référence : Qdrant vector store | Vectors"
description: Documentation de integrating Qdrant with Mastra, a vector similarity search engine for managing vectors and payloads.
packages:
  - "@mastra/qdrant"
---
