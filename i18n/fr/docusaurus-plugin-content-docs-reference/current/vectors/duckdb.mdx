---
title: "Référence : DuckDB vector store | Vectors"
description: Documentation de the DuckDBVector class in Mastra, which provides embedded high-performance vector search using DuckDB with HNSW indexing.
packages:
  - "@mastra/duckdb"
---
...
### Recherche sémantique embarquée
