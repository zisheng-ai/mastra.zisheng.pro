---
title: "Référence : PG vector store | Vectors"
description: Documentation de the PgVector class in Mastra, which provides vector search using PostgreSQL with pgvector extension.
packages:
  - "@mastra/core"
  - "@mastra/fastembed"
  - "@mastra/memory"
