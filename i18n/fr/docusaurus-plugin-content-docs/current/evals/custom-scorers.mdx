...
description: Build reusable custom evaluation scorers with JavaScript functions or LLM prompt objects in Mastra.
packages:
  - "@mastra/core"
---
...
## The four-step pipeline {/* #the-four-step-pipeline */}
...
## Functions vs prompt objects {/* #functions-vs-prompt-objects */}
...
## Initializing a scorer {/* #initializing-a-scorer */}
...
### Minimal judge example (prompt object) {/* #minimal-judge-example-prompt-object */}
...
### Agent Type for Agent Evaluation {/* #agent-type-for-agent-evaluation */}
...
### preprocess Step (Optional) {/* #preprocess-step-optional */}
...
### analyze Step (Optional) {/* #analyze-step-optional */}
...
### `generateScore` step (required) {/* #generatescore-step-required */}
...
### `generateReason` step (optional) {/* #generatereason-step-optional */}
...
### Declarative filtering with `filterRun()` {/* #declarative-filtering-with-filterrun */}
...
### Custom `prepareRun` functions {/* #custom-preparerun-functions */}
...
## Example: Create a custom scorer {/* #example-create-a-custom-scorer */}
...
### Reason Generation {/* #reason-generation */}
...
## High gluten-free example {/* #high-gluten-free-example */}
...
### High gluten-free output {/* #high-gluten-free-output */}
...
## Partial gluten example {/* #partial-gluten-example */}
...
### Partial gluten output {/* #partial-gluten-output */}
...
## Low gluten-free example {/* #low-gluten-free-example */}
...
### Low gluten-free output {/* #low-gluten-free-output */}
