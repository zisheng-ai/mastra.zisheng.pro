...
## Consume A2A agents as subagents {/* #consume-a2a-agents-as-subagents */}
...
## Send requests with the client SDK {/* #send-requests-with-the-client-sdk */}
...
### Use the v1.0 client {/* #use-the-v10-client */}
...
## Configure subagent calls {/* #configure-subagent-calls */}
...
## Sign and verify agent cards {/* #sign-and-verify-agent-cards */}
...
## Verify subagent cards {/* #verify-subagent-cards */}
