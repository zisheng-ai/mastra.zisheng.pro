...
## Combine tools and structured output {/* #combine-tools-and-structured-output */}
...
## LLM structured output support {/* #llm-structured-output-support */}
...
### Use a separate structuring model {/* #use-a-separate-structuring-model */}
...
### Multi-step approach with `prepareStep` {/* #multi-step-approach-with-preparestep */}
