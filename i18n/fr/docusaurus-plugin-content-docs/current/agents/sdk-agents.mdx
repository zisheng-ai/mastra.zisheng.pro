...
## When to use SDK agents {/* #when-to-use-sdk-agents */}
...
## Supported SDK agents {/* #supported-sdk-agents */}
...
### Install Claude packages {/* #install-claude-packages */}
...
### Create a Claude SDK agent {/* #create-a-claude-sdk-agent */}
...
### Add Claude SDK tools {/* #add-claude-sdk-tools */}
...
### Install Cursor packages {/* #install-cursor-packages */}
...
### Create a Cursor SDK agent {/* #create-a-cursor-sdk-agent */}
...
### Use an existing Cursor SDK agent {/* #use-an-existing-cursor-sdk-agent */}
...
### Add Cursor SDK tools {/* #add-cursor-sdk-tools */}
...
### Install OpenAI packages {/* #install-openai-packages */}
...
### Create an OpenAI SDK agent {/* #create-an-openai-sdk-agent */}
...
### Use an existing OpenAI SDK agent {/* #use-an-existing-openai-sdk-agent */}
...
### Add OpenAI SDK tools {/* #add-openai-sdk-tools */}
...
## Register SDK agents {/* #register-sdk-agents */}
...
## Resume SDK runs {/* #resume-sdk-runs */}
