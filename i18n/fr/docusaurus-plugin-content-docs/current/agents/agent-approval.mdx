...
## When to use agent approval {/* #when-to-use-agent-approval */}
...
### Pre-execution approval {/* #pre-execution-approval */}
...
#### Conditional approval with a function {/* #conditional-approval-with-a-function */}
...
#### Bind approval to the exact tool arguments {/* #bind-approval-to-the-exact-tool-arguments */}
...
### Runtime suspension with `suspend()` {/* #runtime-suspension-with-suspend */}
...
## Tool approval with `generate()` {/* #tool-approval-with-generate */}
...
### Stream vs generate comparison {/* #stream-vs-generate-comparison */}
...
## Tool-level approval {/* #tool-level-approval */}
...
### Approval using `requireApproval` {/* #approval-using-requireapproval */}
...
### Approval using `suspend()` {/* #approval-using-suspend */}
...
## Automatic tool resumption {/* #automatic-tool-resumption */}
...
### Manual vs automatic resumption {/* #manual-vs-automatic-resumption */}
...
## Tool approval: Supervisor agents {/* #tool-approval-supervisor-agents */}
...
### Approve and decline in supervisor agents {/* #approve-and-decline-in-supervisor-agents */}
...
### Use `suspend()` in supervisor agents {/* #use-suspend-in-supervisor-agents */}
...
### Supervisor approval with `generate()` {/* #supervisor-approval-with-generate */}
