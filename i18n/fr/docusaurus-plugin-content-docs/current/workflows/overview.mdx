...
## Creating a workflow step {/* #creating-a-workflow-step */}
...
### Using agents and tools {/* #using-agents-and-tools */}
...
## Workflows as steps {/* #workflows-as-steps */}
...
### Cloning a workflow {/* #cloning-a-workflow */}
...
## Referencing a workflow {/* #referencing-a-workflow */}
...
### Workflow result type {/* #workflow-result-type */}
...
### Inspecting workflow stream payloads {/* #inspecting-workflow-stream-payloads */}
...
### Resuming an interrupted workflow stream {/* #resuming-an-interrupted-workflow-stream */}
...
### Workflow using an agent {/* #workflow-using-an-agent */}
...
## Restarting active workflow runs {/* #restarting-active-workflow-runs */}
...
### Restarting all active workflow runs of a workflow with `restartAllActiveWorkflowRuns()` {/* #restarting-all-active-workflow-runs-of-a-workflow-with-restartallactiveworkflowruns */}
...
### Restarting an active workflow run with `restart()` {/* #restarting-an-active-workflow-run-with-restart */}
...
### Identifying active workflow runs {/* #identifying-active-workflow-runs */}
