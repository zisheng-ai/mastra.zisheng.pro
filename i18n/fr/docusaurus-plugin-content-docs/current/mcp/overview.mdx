...
## Expose a Mastra MCP server {/* #expose-a-mastra-mcp-server */}
...
### Define an app resource {/* #define-an-app-resource */}
...
### Connect the app to Studio {/* #connect-the-app-to-studio */}
...
### Register MCP Apps {/* #register-mcp-apps */}
