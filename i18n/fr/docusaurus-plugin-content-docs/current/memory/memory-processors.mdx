...
## Built-in memory processors {/* #built-in-memory-processors */}
...
## Manual control and deduplication {/* #manual-control-and-deduplication */}
...
## Processor execution order {/* #processor-execution-order */}
...
## Guardrails and memory {/* #guardrails-and-memory */}

The default execution order provides safe guardrail behavior:

### Output guardrails (recommended) {/* #output-guardrails-recommended */}
...
## Handling large attachments {/* #handling-large-attachments */}
