...
## How semantic recall works {/* #how-semantic-recall-works */}
...
## Using the `recall()` method {/* #using-the-recall-method */}
...
### Using the Model Router (Recommended) {/* #using-the-model-router-recommended */}
...
### Using AI SDK Packages {/* #using-ai-sdk-packages */}
...
### Using FastEmbed (local) {/* #using-fastembed-local */}
...
## PostgreSQL index optimization {/* #postgresql-index-optimization */}
...
## Disable semantic recall {/* #disable-semantic-recall */}
...
## Viewing recalled messages {/* #viewing-recalled-messages */}
