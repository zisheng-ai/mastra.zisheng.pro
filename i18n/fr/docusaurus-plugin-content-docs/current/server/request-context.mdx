...
## When to use `RequestContext` {/* #when-to-use-requestcontext */}
...
### Setting values based on request headers {/* #setting-values-based-on-request-headers */}
...
## Accessing values with agents {/* #accessing-values-with-agents */}
...
#### Fetching from a prompt registry {/* #fetching-from-a-prompt-registry */}
...
## Accessing values from workflow steps {/* #accessing-values-from-workflow-steps */}
...
## Accessing values with tools {/* #accessing-values-with-tools */}
...
### Agent schema validation {/* #agent-schema-validation */}
