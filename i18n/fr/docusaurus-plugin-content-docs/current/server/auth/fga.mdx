...
## When to use FGA {/* #when-to-use-fga */}
...
### Stored resource scoping {/* #stored-resource-scoping */}
...
### Route policy coverage {/* #route-policy-coverage */}
...
## Custom FGA provider {/* #custom-fga-provider */}
