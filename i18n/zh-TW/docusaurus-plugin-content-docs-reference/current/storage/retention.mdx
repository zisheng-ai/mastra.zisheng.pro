...
### 符合 retention 資格的資料表 {/* #retention-eligible-tables */}
...
## 依排程執行 prune {/* #running-prune-on-a-schedule */}
...
### 在 MongoDB 上設定 TTL 索引 {/* #setting-up-ttl-indexes-on-mongodb */}
