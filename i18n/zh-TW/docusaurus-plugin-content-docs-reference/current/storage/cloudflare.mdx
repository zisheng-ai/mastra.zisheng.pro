...
## Cloudflare KV 儲存空間 {/* #cloudflare-kv-storage */}
...
### 一致性與傳播 {/* #consistency--propagation */}

Cloudflare KV 是最終一致的 store，表示寫入資料後，該資料可能不會立即在所有區域中可用。

### Key 結構與 namespace {/* #key-structure--namespacing */}
...
## Cloudflare Durable Objects 儲存空間 {/* #cloudflare-durable-objects-storage */}
