...
<PropertiesTable
  ...
  },
  {
    name: 'ttl',
    type: 'number',
    description: '此處理器所寫入項目的存留時間（秒）。預設為 300 秒（5 分鐘），與 OpenRouter 的參考實作相同。',
    isOptional: true,
    defaultValue: '300',
  },
  {
  ...
  },
  {
    name: 'bust',
    type: 'boolean',
    description: '強制每次呼叫都不命中快取：略過讀取，但仍在完成時寫入。適合用於明確的重新整理路徑。',
    isOptional: true,
    defaultValue: 'false',
  },
  {
...
<PropertiesTable
  ...
  },
  {
    ...
    description: 'Provider 實際會收到的提示詞，位於記憶體載入及所有會修改提示詞的輸入處理器執行之後。',
    isOptional: false,
  },
  {
    name: 'stepNumber',
