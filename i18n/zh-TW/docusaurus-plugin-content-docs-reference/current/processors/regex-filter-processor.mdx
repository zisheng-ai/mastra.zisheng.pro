...
<PropertiesTable
  content={[
  {
    name: 'rules',
    type: 'RegexRule[]',
    description: '要套用的自訂 regex 規則。每項規則都有名稱、regex 模式，以及選用的替代字串。',
    isOptional: true,
    properties: [
      {
        type: 'RegexRule',
  ...
  },
  {
    ...
    description: "要套用篩選器的階段。'input' 會篩選輸入訊息；'output' 會篩選輸出串流與結果；'all' 會同時篩選兩者。",
    isOptional: true,
    defaultValue: "'all'",
  },
  {
    ...
    type: 'boolean',
    description: '是否在每個報告項目中包含已遮蔽的文字。預設關閉，因為這些值正是處理器要移除的資料。',
    isOptional: true,
    defaultValue: 'false',
  },
  {
...
<PropertiesTable
  ...
  },
  {
    ...
    description: '以所有設定的規則檢查輸入訊息，並依策略封鎖、遮蔽或提出警告。phase 為 output 時會略過。',
    isOptional: false,
  },
  {
  ...
  },
  {
    ...
    description: '以所有設定的規則檢查輸出訊息，並依策略封鎖、遮蔽或提出警告。phase 為 input 時會略過。',
    isOptional: false,
  },
]}
/>
...
<PropertiesTable
  ...
  },
  {
    name: 'partIndex',
    type: 'number',
    description: '已遮蔽部分在訊息 parts 陣列中的索引；該陣列也包含非文字部分。字串內容和串流區塊沒有此值。',
    isOptional: true,
  },
  {
    name: 'redactions',
