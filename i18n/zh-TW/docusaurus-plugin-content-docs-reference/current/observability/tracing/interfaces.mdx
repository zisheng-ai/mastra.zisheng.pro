...
<PropertiesTable
  ...
  },
  {
    name: 'timestamp',
    type: 'Date',
    description: '記錄分數的時間。Exporter 會收到 Date 物件，該物件透過 JSON 序列化為 ISO 8601 字串。',
    required: true,
  },
  {
    name: 'traceId',
  ...
  },
  {
    name: 'scoreSource',
    type: 'string',
    description: '用於識別分數產生方式的自由格式字串。常見值包括 manual、automated 與 experiment。',
  },
  {
    name: 'score',
    type: 'number',
...
## Config selector 型別 {/* #config-selector-types */}
