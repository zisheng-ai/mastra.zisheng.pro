...
## 將 Agent 公開為 Tool {/* #exposing-agents-as-tools */}
...
### 將 Agent 轉換為 Tool {/* #agent-to-tool-conversion */}
...
### 在 Tool 中存取 MCP context {/* #accessing-mcp-context-in-tools */}
...
#### 範例：適用於兩種 context 的 Tool {/* #example-tool-that-works-in-both-contexts */}
...
### 什麼是 MCP Resource？ {/* #what-are-mcp-resources */}
...
### `MCPServerResources` 型別 {/* #mcpserverresources-type */}
...
### 通知 client resource 變更 {/* #notifying-clients-of-resource-changes */}
...
## Prompt 處理 {/* #prompt-handling */}

### 什麼是 MCP Prompt？ {/* #what-are-mcp-prompts */}
...
### `MCPServerPrompts` 型別 {/* #mcpserverprompts-type */}
...
### 通知 client Prompt 變更 {/* #notifying-clients-of-prompt-changes */}
...
### Prompt 處理最佳做法 {/* #best-practices-for-prompt-handling */}
...
## 動態 Tool 管理 {/* #dynamic-tool-management */}
...
### 什麼是 Elicitation？ {/* #whats-elicitation */}
...
### Tool 執行 signature {/* #tool-execution-signature */}
...
### Elicitation 的運作方式 {/* #how-elicitation-works */}
...
### Tool 執行 API {/* #tool-execution-api */}
...
### OAuth middleware 選項 {/* #oauth-middleware-options */}
...
## 驗證 context {/* #authentication-context */}
...
### 為 FGA 對應驗證資料 {/* #map-auth-data-for-fga */}
...
### 個別設定 MCP Tool FGA scope {/* #scope-mcp-tool-fga-separately */}
...
### 設定驗證 middleware {/* #setting-up-authentication-middleware */}
...
### 在 Tool 中存取驗證資料 {/* #accessing-auth-data-in-tools */}
...
### 將 `RequestContext` 傳遞至 Agent {/* #passing-requestcontext-through-to-agent */}
...
### `AppResources` 型別 {/* #appresources-type */}
