...
### 所有 Tool 都要求核准 {/* #require-approval-for-all-tools */}
...
### 使用函式動態核准 {/* #dynamic-approval-with-a-function */}
...
### 使用可信任 server 的 Tool annotation {/* #use-tool-annotations-from-a-trusted-server */}
...
## Server instructions 設定 {/* #server-instructions */}
...
### Stdio server 的 subprocess 環境 {/* #subprocess-environment-for-stdio-servers */}
...
### 使用 `allowedHosts` 限制對外 host {/* #restricting-outbound-hosts-with-allowedhosts */}
...
### 將 Tool response 視為不受信任的輸入 {/* #treat-tool-responses-as-untrusted-input */}
...
### `resources` 屬性 {/* #resources-property */}
...
### `elicitation` 屬性 {/* #elicitation-property */}
...
##### `ElicitationHandler` 函式 {/* #elicitationhandler-function */}
...
### 設定 Elicitation {/* #setting-up-elicitation */}
...
### 根據 schema 收集輸入 {/* #schema-based-input-collection */}
...
### 互動式瀏覽器驗證 {/* #interactive-browser-authentication */}
...
### 自訂 token 儲存空間 {/* #custom-token-storage */}
...
### 靜態 Tool 設定 {/* #static-tool-configuration */}
...
## Instance 管理 {/* #instance-management */}
...
## 使用自訂 fetch 進行執行階段定義的驗證 {/* #using-custom-fetch-for-runtime-defined-authentication */}
...
## 在自訂 fetch 中處理驗證失敗 {/* #handling-auth-failures-inside-custom-fetch */}
...
## 使用 SSE request header {/* #using-sse-request-headers */}
