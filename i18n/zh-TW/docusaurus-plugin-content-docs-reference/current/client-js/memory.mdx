...
## 建立新 thread {/* #create-a-new-thread */}
...
## 使用特定 thread {/* #working-with-a-specific-thread */}
...
## Thread 方法 {/* #thread-methods */}

### 取得 thread 詳情 {/* #get-thread-details */}
...
### 取得 thread 訊息 {/* #retrieve-thread-messages */}
...
### 取得 Working memory {/* #get-working-memory */}
...
### 更新 Working memory {/* #update-working-memory */}
...
### 取得 Memory 狀態 {/* #get-memory-status */}
