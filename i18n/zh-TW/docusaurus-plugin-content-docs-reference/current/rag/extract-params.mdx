...
description: Mastra 中中繼資料擷取設定的文件。
packages:
  - "@mastra/rag"
---
...
<PropertiesTable
  content={[
  {
    ...
    isOptional: true,
    description: '啟用標題擷取。設為 true 可使用預設設定，或提供自訂設定。',
  },
  {
    name: 'summary',
    type: 'boolean | SummaryExtractArgs',
    isOptional: true,
    description: '啟用摘要擷取。設為 true 可使用預設設定，或提供自訂設定。',
  },
  {
    name: 'questions',
    type: 'boolean | QuestionAnswerExtractArgs',
    isOptional: true,
    description: '啟用問題生成。設為 true 可使用預設設定，或提供自訂設定。',
  },
  {
    name: 'keywords',
    type: 'boolean | KeywordExtractArgs',
    isOptional: true,
    description: '啟用關鍵字擷取。設為 true 可使用預設設定，或提供自訂設定。',
  },
  {
    name: 'schema',
...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'number',
    isOptional: true,
    description: '要擷取的標題節點數量',
  },
  {
    name: 'nodeTemplate',
    type: 'string',
    isOptional: true,
    description: '擷取標題節點的自訂提示範本。必須包含 {context} 預留位置',
  },
  {
    name: 'combineTemplate',
    type: 'string',
    isOptional: true,
    description: '合併標題的自訂提示範本。必須包含 {context} 預留位置',
  },
]}
/>
...
<PropertiesTable
  ...
  },
  {
    ...
    type: "('self' | 'prev' | 'next')[]",
    isOptional: true,
    description: "要產生的摘要類型清單。只能包含 'self'（目前區塊）、'prev'（上一個區塊）或 'next'（下一個區塊）",
  },
  {
    name: 'promptTemplate',
    type: 'string',
    isOptional: true,
    description: '生成摘要的自訂提示範本。必須包含 {context} 預留位置',
  },
]}
/>
...
<PropertiesTable
  content={[
  {
    ...
    type: 'MastraLanguageModel',
    isOptional: true,
    description: '用於生成問題的 AI SDK 語言模型',
  },
  {
    name: 'questions',
    type: 'number',
    isOptional: true,
    description: '要生成的問題數量',
  },
  {
    name: 'promptTemplate',
    type: 'string',
    isOptional: true,
    description: '生成問題的自訂提示範本。必須同時包含 {context} 與 {numQuestions} 預留位置',
  },
  {
    name: 'embeddingOnly',
    type: 'boolean',
    isOptional: true,
    description: '若為 true，僅產生嵌入，不產生實際問題',
  },
]}
/>
...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'number',
    isOptional: true,
    description: '要擷取的關鍵字數量',
  },
  {
    name: 'promptTemplate',
    type: 'string',
    isOptional: true,
    description: '擷取關鍵字的自訂提示範本。必須同時包含 {context} 與 {maxKeywords} 預留位置',
  },
]}
/>
...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'string',
    isOptional: true,
    description: '擷取結果所要巢狀置入的鍵。若省略，結果會展開至中繼資料物件中。',
  },
]}
/>
