...
<PropertiesTable
  ...
  },
  {
    ...
    description: "執行瀏覽器的環境。雲端執行請使用 'BROWSERBASE'。",
    isOptional: true,
    defaultValue: "'LOCAL'",
  },
  {
    name: 'apiKey',
    type: 'string',
    description: "Browserbase API key。env 為 'BROWSERBASE' 時必填。",
    isOptional: true,
  },
  {
    name: 'projectId',
    type: 'string',
    description: "Browserbase project ID。env 為 'BROWSERBASE' 時必填。",
    isOptional: true,
  },
  {
    name: 'model',
  ...
  },
  {
    name: 'selfHeal',
    type: 'boolean',
    description: '啟用自我修復 selector。啟用後，初始 selector 失敗時，Stagehand 會使用 AI 尋找 element。',
    isOptional: true,
    defaultValue: 'true',
  },
  {
    ...
    type: 'number',
    description: '動作完成後等待 DOM 穩定的逾時毫秒數。',
    isOptional: true,
    defaultValue: '5000',
  },
  {
    name: 'verbose',
    type: '0 | 1 | 2',
    description: 'logging 詳細程度。0 = 靜默，1 = 僅錯誤，2 = 詳細。',
    isOptional: true,
    defaultValue: '1',
  },
  { name: 'systemPrompt', type: 'string', description: 'AI 操作的自訂 system prompt。', isOptional: true },
  {
    ...
    description: '用於連線至現有瀏覽器的 CDP WebSocket URL 或 HTTP endpoint。HTTP endpoint 會在內部解析為 WebSocket。',
    isOptional: true,
  },
  {
    name: 'scope',
    type: "'shared' | 'thread'",
    description: '瀏覽器 instance 跨 thread 的範圍。',
    isOptional: true,
  ...
  },
  {
    name: 'timeout',
    type: 'number',
    description: 'Stagehand 操作的預設逾時毫秒數。',
    isOptional: true,
    defaultValue: '30000',
  },
  {
