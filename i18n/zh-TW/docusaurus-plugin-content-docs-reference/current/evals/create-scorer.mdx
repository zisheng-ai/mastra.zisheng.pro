...
## 如何建立自訂評分器 {/* #how-to-create-a-custom-scorer */}
...
## `createScorer` 選項 {/* #createscorer-options */}
...
## 重試 judge 要求 {/* #retry-judge-requests */}
...
### 覆寫單一步驟的重試設定 {/* #override-retries-for-one-step */}
...
### Agent 型別捷徑 {/* #agent-type-shortcut */}
...
### 使用泛型的自訂型別 {/* #custom-types-with-generics */}
...
### 內建 Agent 型別 {/* #built-in-agent-types */}
...
## 使用 Agent 型別進行 Trace 評分 {/* #trace-scoring-with-agent-types */}
