...
## 上下文選取最佳化 {/* #context-selection-optimization */}
...
### 與上下文精確率的差異 {/* #difference-from-context-precision */}
...
### 結合多個上下文來源 {/* #combining-multiple-context-sources */}
...
### 動態擷取上下文 {/* #dynamic-context-extraction-1 */}
