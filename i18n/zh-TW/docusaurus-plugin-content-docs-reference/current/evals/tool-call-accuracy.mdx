...
## 以程式碼為基礎的 Tool 呼叫準確度評分器 {/* #code-based-tool-call-accuracy-scorer */}
...
### 以程式碼為基礎的評分器選項 {/* #code-based-scorer-options */}
...
### Tool 順序驗證 {/* #tool-order-validation */}
...
## 以 LLM 為基礎的 Tool 呼叫準確度評分器 {/* #llm-based-tool-call-accuracy-scorer */}
...
## 以 LLM 為基礎的評分器範例 {/* #llm-based-scorer-examples */}
...
### 處理不適當的 Tool 使用情形 {/* #handling-inappropriate-tool-usage */}
...
### 評估釐清要求 {/* #evaluating-clarification-requests */}
...
## 比較兩款評分器 {/* #comparing-both-scorers */}
