...
### 為何這是 CI 評分器 {/* #why-this-is-a-ci-scorer */}
...
### 範例：CI 測試實作 {/* #example-ci-test-implementation */}
...
### 5. 抵抗幻覺的能力 {/* #5-hallucination-resistance */}
...
### 完整的 Vitest 範例 {/* #complete-vitest-example */}
...
## 容易受干擾內容影響的範例 {/* #distractor-vulnerability-example */}
...
## 受到嚴重破壞的範例 {/* #severe-compromise-example */}
...
## CI pipeline：批次評估以比較模型 {/* #ci-pipeline-batch-evaluation-for-model-comparison */}
...
## CI 中的安全性測試 {/* #security-testing-in-ci */}
