...
<PropertiesTable
  ...
  },
  {
    name: 'toolCall',
    type: 'event',
    description: '模型請求呼叫 Tool 時發出。回呼會收到 { name: string, args: object, id: string }。',
  },
  {
    name: 'usage',
    type: 'event',
  ...
  },
  {
    name: 'error',
    type: 'event',
    description: '發生錯誤時發出。回呼會收到 { message: string, code?: string, details?: unknown }。',
  },
...
### Gemini API（開發環境） {/* #gemini-api-development */}
...
### Vertex AI（正式環境） {/* #vertex-ai-production */}
