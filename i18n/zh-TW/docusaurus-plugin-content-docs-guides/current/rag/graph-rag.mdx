...
## 適合使用 GraphRAG 的情境 {/* #when-to-use-graphrag */}
...
## 搭配 Agent 使用 GraphRAG {/* #using-graphrag-with-agents */}
...
## 文件處理與儲存 {/* #document-processing-and-storage */}
...
## 選擇適當的閾值 {/* #choosing-the-right-threshold */}
...
## 與其他檢索方法搭配使用 {/* #combining-with-other-retrieval-methods */}
