...
## 安裝終端機相依套件 {/* #install-the-terminal-dependencies */}
...
## 建立 coding agent {/* #create-the-coding-agent */}
...
## 註冊 coding agent {/* #register-the-coding-agent */}
...
## 測試 coding agent {/* #test-the-coding-agent */}
...
## 建立 Agent controller {/* #create-the-agent-controller */}
...
## 建置終端機 UI {/* #build-the-terminal-ui */}
...
## 執行 coding agent {/* #run-the-coding-agent */}
