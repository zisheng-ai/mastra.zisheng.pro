...
## 使用 `.stream()` 或 `.generate()` 取代 `.network()` {/* #replace-network-with-stream-or-generate */}
...
## 撰寫清楚的 supervisor 指示 {/* #write-clear-supervisor-instructions */}
...
## 為 subagent 新增描述 {/* #add-descriptions-to-subagents */}
...
## 更新事件處理方式 {/* #update-event-handling */}
...
## 新增委派 hook {/* #add-delegation-hooks */}
...
## 新增迭代監控 {/* #add-iteration-monitoring */}
...
## 新增任務完成度評分 {/* #add-task-completion-scoring */}
