...
description: 概述 Mastra 的 Voice 功能，包括文字轉語音、語音轉文字及即時語音轉語音互動。
packages:
  - "@mastra/core"
  - "@mastra/node-audio"
...
## 為 Agent 加入 Voice {/* #add-voice-to-agents */}
...
使用 Mastra 的 TTS 功能，將 Agent 回應轉換成自然的語音。
你可以從 OpenAI、ElevenLabs 等多個 Provider 中選擇。

如需詳細設定選項與進階功能，請參閱[文字轉語音指南](./text-to-speech)。
...
<Tabs>
  <TabItem value="openai" label="OpenAI">
    ...
    如需 OpenAI Voice Provider 的詳細資訊，請參閱 [OpenAI Voice 參考文件](/reference/voice/openai)。
  </TabItem>
  ...
  <TabItem value="azure" label="Azure">
    ...
    如需 Azure Voice Provider 的詳細資訊，請參閱 [Azure Voice 參考文件](/reference/voice/azure)。
  </TabItem>
  ...
  <TabItem value="elevenlabs" label="ElevenLabs">
    ...
    如需 ElevenLabs Voice Provider 的詳細資訊，請參閱 [ElevenLabs Voice 參考文件](/reference/voice/elevenlabs)。
  </TabItem>
  ...
  <TabItem value="playai" label="PlayAI">
    ...
    如需 PlayAI Voice Provider 的詳細資訊，請參閱 [PlayAI Voice 參考文件](/reference/voice/playai)。
  </TabItem>
  ...
  <TabItem value="google" label="Google">
    ...
    如需 Google Voice Provider 的詳細資訊，請參閱 [Google Voice 參考文件](/reference/voice/google)。
  </TabItem>
  ...
  <TabItem value="cloudflare" label="Cloudflare">
    ...
    如需 Cloudflare Voice Provider 的詳細資訊，請參閱 [Cloudflare Voice 參考文件](/reference/voice/cloudflare)。
  </TabItem>
  ...
  <TabItem value="deepgram" label="Deepgram">
    ...
    如需 Deepgram Voice Provider 的詳細資訊，請參閱 [Deepgram Voice 參考文件](/reference/voice/deepgram)。
  </TabItem>
  ...
  <TabItem value="inworld" label="Inworld">
    ...
    如需 Inworld Voice Provider 的詳細資訊，請參閱 [Inworld Voice 參考文件](/reference/voice/inworld)。
  </TabItem>
  ...
  <TabItem value="speechify" label="Speechify">
    ...
    如需 Speechify Voice Provider 的詳細資訊，請參閱 [Speechify Voice 參考文件](/reference/voice/speechify)。
  </TabItem>
  ...
  <TabItem value="sarvam" label="Sarvam">
    ...
    如需 Sarvam Voice Provider 的詳細資訊，請參閱 [Sarvam Voice 參考文件](/reference/voice/sarvam)。
  </TabItem>
  ...
  <TabItem value="murf" label="Murf">
    ...
    如需 Murf Voice Provider 的詳細資訊，請參閱 [Murf Voice 參考文件](/reference/voice/murf)。
  </TabItem>
</Tabs>

### 語音轉文字（STT） {/* #speech-to-text-stt */}

使用 OpenAI、ElevenLabs 等 Provider 轉錄語音內容。如需詳細設定選項與其他資訊，請參閱[語音轉文字](./speech-to-text)。

你可以從[此處](https://github.com/mastra-ai/realtime-voice-demo/raw/refs/heads/main/how_can_i_help_you.mp3)下載音訊範例檔案。
...
運用語音轉語音功能建立對話體驗。統一 API 能讓使用者與 AI Agent 進行即時語音互動。
如需詳細設定選項與進階功能，請參閱[語音轉語音](./speech-to-speech)。
...
<Tabs>
  <TabItem value="openai" label="OpenAI">
    ...
    如需 OpenAI Voice Provider 的詳細資訊，請參閱 [OpenAI Voice 參考文件](/reference/voice/openai-realtime)。
  </TabItem>
  ...
  <TabItem value="google" label="Google">
    ...
    如需 Google Gemini Live Voice Provider 的詳細資訊，請參閱 [Google Gemini Live 參考文件](/reference/voice/google-gemini-live)。
  </TabItem>
  ...
  <TabItem value="aws-nova-sonic" label="AWS Nova Sonic">
    ...
    如需 AWS Nova Sonic Voice Provider 的詳細資訊，請參閱 [AWS Nova Sonic 參考文件](/reference/voice/aws-nova-sonic)。
  </TabItem>
  ...
  <TabItem value="inworld-realtime" label="Inworld Realtime">
    ...
    如需 Inworld Realtime Voice Provider 的詳細資訊，請參閱 [Inworld Realtime 參考文件](/reference/voice/inworld-realtime)。
  </TabItem>
  ...
  <TabItem value="xai" label="xAI">
    ...
    如需 xAI Voice Provider 的詳細資訊，請參閱 [xAI Realtime Voice 參考文件](/reference/voice/xai-realtime)。
  </TabItem>
</Tabs>

### 即時 Voice {/* #realtime-voice */}

在瀏覽器或電話上執行使用者可隨時插話的即時通話。Mastra 將音訊迴圈交由 LiveKit 處理語音活動偵測、語意回合偵測與插話，而 Agent 則使用自己的模型、Tool 與 Memory 產生每次回應。設定方式與選項請參閱[即時 Voice](./realtime-voice)。
...
<Tabs>
  ...
  <TabItem value="openai-realtime" label="OpenAI Realtime">
    ...
    如需 OpenAI Realtime Voice Provider 的詳細資訊，請參閱 [OpenAI Realtime Voice 參考文件](/reference/voice/openai-realtime)。
  </TabItem>
  ...
  <TabItem value="xai-realtime" label="xAI Realtime">
    ...
    如需 xAI realtime Voice Provider 的詳細資訊，請參閱 [xAI Realtime Voice 參考文件](/reference/voice/xai-realtime)。
  </TabItem>
...
### 使用多個 Voice Provider {/* #using-multiple-voice-providers */}
...
如需 CompositeVoice 的詳細資訊，請參閱 [CompositeVoice 參考文件](/reference/voice/composite-voice)。
