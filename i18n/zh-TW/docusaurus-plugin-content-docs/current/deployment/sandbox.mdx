...
### Provider 認證資訊 {/* #provider-credentials */}
...
## 以程式部署 {/* #deploying-programmatically */}
...
### 第 1 層：直接 URL {/* #tier-1-direct-url */}

開發、示範與 CI 可直接使用印出的 URL，前提是每次部署使用全新 URL 沒有問題。

### 第 2 層：在 runtime 解析 {/* #tier-2-resolve-at-runtime */}
...
### 第 3 層：提供終端使用者的穩定 URL {/* #tier-3-stable-url-for-end-users */}
