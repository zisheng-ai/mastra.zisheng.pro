...
## 適合使用 SDK Agent 的時機 {/* #when-to-use-sdk-agents */}
...
### 新增 Claude SDK Tool {/* #add-claude-sdk-tools */}
...
### 新增 Cursor SDK Tool {/* #add-cursor-sdk-tools */}
...
### 新增 OpenAI SDK Tool {/* #add-openai-sdk-tools */}
