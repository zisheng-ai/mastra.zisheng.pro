...
## 使用處理器的時機 {/* #when-to-use-processors */}
...
## 將處理器附加至 Agent {/* #attach-processors-to-an-agent */}
...
### 覆寫單次呼叫的處理器 {/* #override-processors-per-call */}
...
## 建立自訂處理器 {/* #create-custom-processors */}
...
### 呼叫 Provider 後處理 LLM 回應 {/* #act-on-the-llm-response-after-the-provider-call */}
...
### 使用 `prepareStep()` 回呼 {/* #use-the-preparestep-callback */}
...
### 跨區塊與步驟保存資料 {/* #persist-data-across-chunks-and-steps */}
...
## 內建公用處理器 {/* #built-in-utility-processors */}
...
### 使用回應快取的時機 {/* #when-to-use-response-caching */}
...
### 透過 RequestContext 覆寫單次呼叫設定 {/* #per-call-overrides-via-requestcontext */}
...
### 快取鍵包含的內容 {/* #whats-in-the-cache-key */}
...
### 傳遞提醒但不保留 {/* #deliver-a-reminder-without-retaining-it */}
...
### 將中繼資料加入訊息 {/* #add-metadata-to-messages */}
...
### 中止與 tripwire 區塊 {/* #abort-and-tripwire-chunks */}
