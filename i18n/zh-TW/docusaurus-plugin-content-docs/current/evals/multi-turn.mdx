...
## 多輪 Evals 的適用時機 {/* #when-to-use-multi-turn-evals */}
...
## 跨輪回想需要記憶體 {/* #memory-is-required-for-cross-turn-recall */}
...
## 使用 `turns` 進行逐輪斷言 {/* #per-turn-assertions-with-turns */}
...
## 結合閘門與臨界值 {/* #combining-with-gates-and-thresholds */}
...
## 混用單輪與多輪項目 {/* #mixing-single-turn-and-multi-turn */}
