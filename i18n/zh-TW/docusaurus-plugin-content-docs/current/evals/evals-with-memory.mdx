...
<a id="shared-thread-with-runevals" />

## 透過 `runEvals` 共用 thread
...
<a id="per-item-threads-with-runevals" />

## 透過 `runEvals` 為每個項目建立 thread
...
<a id="dataset-experiments-with-an-inline-task" />
