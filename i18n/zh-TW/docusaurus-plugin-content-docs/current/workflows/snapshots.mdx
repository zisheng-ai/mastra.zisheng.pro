...
## 快照在暫停與繼續中的作用 {/* #the-role-of-snapshots-in-suspend-and-resume */}
...
## 如何儲存與擷取快照 {/* #how-snapshots-are-saved-and-retrieved */}
...
## 自訂快照中繼資料 {/* #custom-snapshot-metadata */}
