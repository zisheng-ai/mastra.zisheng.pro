...
## 內建 Memory processor {/* #built-in-memory-processors */}
...
## 手動控制與去除重複項目 {/* #manual-control-and-deduplication */}
...
## Processor 執行順序 {/* #processor-execution-order */}

將 guardrail 與 Memory 搭配使用時，瞭解執行順序相當重要：

### 輸入 processor {/* #input-processors */}
...
### 輸出 processor {/* #output-processors */}
...
## Guardrail 與 Memory {/* #guardrails-and-memory */}

預設執行順序可提供安全的 guardrail 行為：

### 輸出 guardrail（建議） {/* #output-guardrails-recommended */}
