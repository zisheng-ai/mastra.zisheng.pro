...
## 何時使用多使用者 thread {/* #when-to-use-multi-user-threads */}
...
## 讓所有參與者共用一個 `resourceId` {/* #share-one-resourceid-across-all-participants */}
...
## 使用發話者身分標記每則使用者訊息 {/* #tag-each-user-message-with-the-speakers-identity */}
...
## 與 Memory 層搭配使用 {/* #combining-with-memory-layers */}
...
### 搭配 Observational Memory（建議） {/* #with-observational-memory-recommended */}
...
### 搭配 working memory {/* #with-working-memory */}
