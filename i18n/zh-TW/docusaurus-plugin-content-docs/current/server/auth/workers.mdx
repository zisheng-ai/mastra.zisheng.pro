...
## 設定 worker 驗證 {/* #setting-up-worker-auth */}

### 在伺服器上設定驗證 Provider {/* #configure-an-auth-provider-on-the-server */}
...
### 設定 worker 權杖 {/* #set-the-worker-token */}
...
## 驗證認證資訊類型 {/* #auth-credential-types */}
...
## 推送模式 broker 驗證 {/* #push-mode-broker-auth */}
...
## 安全性建議 {/* #security-recommendations */}
