...
### 支援 Observability 的 Provider {/* #providers-with-observability-support */}
...
### 不支援 Observability 的 Provider {/* #providers-without-observability-support */}
...
### 建議：在高流量正式環境使用 ClickHouse {/* #recommended-clickhouse-for-high-volume-production */}
...
## 被捨棄的 Observability 事件 {/* #dropped-observability-events */}
