...
## 新增自訂 metadata {/* #adding-custom-metadata */}
...
### 使用部署環境標記 Trace {/* #tagging-traces-with-the-deployment-environment */}
...
#### 設定層級的擷取 {/* #configuration-level-extraction */}
...
#### 為個別請求新增 key {/* #per-request-additions */}
...
### 為 Trace 新增標籤 {/* #adding-tags-to-traces */}
...
### 隱藏敏感的輸入／輸出 {/* #hiding-sensitive-inputoutput */}
...
#### 內建 Processor {/* #built-in-processors */}
...
### Custom span formatter {/* #custom-span-formatters */}
