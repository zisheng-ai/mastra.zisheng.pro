...
## 何時使用訊號 Provider {/* #when-to-use-a-signal-provider */}
...
## 訊號 Provider 的運作方式 {/* #how-signal-providers-work */}
...
## 輪詢與 Webhook Provider {/* #polling-and-webhook-providers */}
...
## 內建 Webhook Provider {/* #built-in-webhook-provider */}
...
## 進階 Provider 能力 {/* #advanced-provider-capabilities */}
