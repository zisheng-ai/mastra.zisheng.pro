...
### Gateway 自有驗證 {/* #gateway-owned-authentication */}
...
#### 在開發環境中自動產生型別 {/* #automatic-type-generation-in-development */}
...
#### 手動產生型別的替代方案 {/* #manual-type-generation-alternatives */}
...
## Gateway ID 與 key 的差異 {/* #gateway-ids-vs-keys */}
...
## 在 Studio 中只顯示自訂 Gateway {/* #showing-only-custom-gateways-in-studio */}
