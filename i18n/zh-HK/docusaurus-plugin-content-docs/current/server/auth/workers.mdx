...
## 設定 Worker 身份驗證 {/* #setting-up-worker-auth */}

### 在伺服器上設定 auth provider {/* #configure-an-auth-provider-on-the-server */}
...
### 設定 Worker token {/* #set-the-worker-token */}
...
## 身份驗證憑證類型 {/* #auth-credential-types */}
...
## 推送模式 broker 身份驗證 {/* #push-mode-broker-auth */}
