...
## 何時使用伺服器適配器 {/* #when-to-use-server-adapters */}
...
## 覆寫個別路由的身份驗證設定 {/* #per-route-auth-overrides */}
...
### 僅限適配器 constructor {/* #adapter-constructor-only */}
...
### 適配器不會使用的設定 {/* #not-used-by-adapters */}
