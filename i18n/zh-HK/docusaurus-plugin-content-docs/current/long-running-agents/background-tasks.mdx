...
## 在背景運行 Tool {/* #run-a-tool-in-the-background */}
...
### LLM 的單次調用覆寫 {/* #llm-per-call-override */}
...
## 與背景任務相關的串流區塊 {/* #background-tasks-related-stream-chunks */}
...
## 使用 `untilIdle` 保持 Agent 串流開啟 {/* #keep-the-agent-stream-open-with-untilidle */}
...
## 在背景運行 subagent {/* #subagents-in-the-background */}
...
### 從 subagent 繼承 {/* #inheriting-from-the-subagent */}
...
### 直接查閱任務狀態 {/* #look-up-task-state-directly */}
