...
## 何時使用 signals {/* #when-to-use-signals */}
...
### 將訊息排入下一個 turn {/* #queue-a-message-for-the-next-turn */}
...
### 控制底層 signal 行為 {/* #control-low-level-signal-behavior */}
...
### 傳送通知上下文 {/* #send-notification-context */}
...
### 傳送 processor 上下文 {/* #send-processor-context */}
...
## 狀態及通知 signals {/* #state-and-notification-signals */}

### 狀態 signals {/* #state-signals */}
...
### 通知 signals {/* #notification-signals */}
...
#### 通知收件箱 Tool {/* #notification-inbox-tool */}
...
## 分散式及 serverless 部署 {/* #distributed-and-serverless-deployments */}
...
## 相容性及 API {/* #compatibility-and-apis */}
...
### 使用 HTTP routes {/* #use-http-routes */}
...
### 使用 client SDK {/* #use-the-client-sdk */}
...
### 保持自訂 SSE 訂閱連線 {/* #keep-custom-sse-subscriptions-alive */}
