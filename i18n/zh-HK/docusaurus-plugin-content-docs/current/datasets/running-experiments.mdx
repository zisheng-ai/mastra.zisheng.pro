...
#### 已啟用記憶的 Agent {/* #memory-enabled-agents */}
...
## 控制每次執行的保存設定 {/* #control-persistence-per-run */}
...
### 配對與消耗 {/* #matching-and-consumption */}
...
### 固定數據集版本 {/* #pinning-a-dataset-version */}
...
## 了解摘要 {/* #understanding-the-summary */}
