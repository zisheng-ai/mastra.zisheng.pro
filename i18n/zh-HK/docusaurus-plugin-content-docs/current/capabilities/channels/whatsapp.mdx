...
請依照 [Chat SDK WhatsApp adapter 文件](https://chat-sdk.dev/adapters/official/whatsapp)完成 WhatsApp 專屬設定，包括 Meta 應用程式設定、存取權杖、電話號碼 ID、webhook 驗證及訊息限制。
...
- [更多內容](/docs/capabilities/channels/other-adapters)
