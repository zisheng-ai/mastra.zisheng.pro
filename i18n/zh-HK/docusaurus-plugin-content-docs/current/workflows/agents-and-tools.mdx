...
### 將 Agent 用作 step {/* #agents-as-steps */}
...
### 使用結構化輸出的 Agent {/* #agents-with-structured-output */}
...
### `.agent()` 簡寫方式 {/* #the-agent-shorthand */}
...
## 在 Workflow 中使用 Tool {/* #using-tools-in-workflows */}
