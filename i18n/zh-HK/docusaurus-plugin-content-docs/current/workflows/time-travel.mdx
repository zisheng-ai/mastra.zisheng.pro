...
## 提供執行 context {/* #providing-execution-context */}
...
## 對已暫停的 Workflow 使用時間旅行 {/* #time-travel-with-suspended-workflows */}
...
## 對初始狀態使用時間旅行 {/* #time-travel-with-initial-state */}
...
### 正在運行的 Workflow {/* #running-workflow */}
...
## 巢狀 Workflow 的 context {/* #nested-workflows-context */}
...
### 為失敗的步驟除錯 {/* #debugging-failed-steps */}
...
### 在新的 Workflow run 上測試步驟邏輯 {/* #testing-step-logic-on-new-workflow-run */}
...
### 從暫時性故障中復原 {/* #recovering-from-transient-failures */}
