...
# MongoDB 向量儲存 {/* #mongodb-vector-store */}
...
### 自訂 embedding 欄位路徑 {/* #custom-embedding-field-path */}
...
### 使用 `MongoDB` 的向量 embedding {/* #vector-embeddings-with-mongodb */}
...
### 使用 VoyageAI 的向量 embedding {/* #vector-embeddings-with-voyageai */}
