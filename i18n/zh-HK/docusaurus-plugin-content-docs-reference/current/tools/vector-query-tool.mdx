...
<PropertiesTable
  content={[
  {
    name: 'id',
    type: 'string',
    description: "Tool 的自訂 ID。預設為：'VectorQuery {vectorStoreName} {indexName} Tool'。（只可在建立時設定。）",
    isOptional: true,
  },
  {
    name: 'description',
    type: 'string',
    description: "Tool 的自訂說明。預設為：'存取知識庫，以尋找回答使用者問題所需的資料'（只可在建立時設定。）",
    isOptional: true,
  },
  {
    name: 'model',
  ...
  },
  {
    name: 'includeSources',
    type: 'boolean',
    description: '在結果中包含完整的擷取物件。（可在建立時設定，或在執行階段覆寫。）',
    isOptional: true,
    defaultValue: 'true',
  },
  {
  ...
  },
  {
    name: 'databaseConfig',
    type: 'DatabaseConfig',
    description: '用於最佳化查詢的資料庫專用設定選項。（可在建立時設定，或在執行階段覆寫。）',
    isOptional: true,
    properties: [
      {
        type: 'DatabaseConfig',
...
<PropertiesTable
  ...
  },
  {
    name: 'sources',
    type: 'QueryResult[]',
    description: '完整擷取結果物件的陣列。每個物件都包含參照原始文件、chunk 及相似度分數所需的全部資料。',
  },
]}
/>
...
## 預設 Tool 說明 {/* #default-tool-description */}
...
## 結果處理 {/* #result-handling */}

此 Tool 會根據使用者查詢決定傳回的結果數目，預設為 10 項。你可根據查詢要求調整此數目。

## 使用 filter 的範例 {/* #example-with-filters */}
...
## 使用重新排序的範例 {/* #example-with-reranking */}
...
## 使用自訂說明的範例 {/* #example-with-custom-description */}
...
<Tabs>
  ...
  <TabItem value="pgvector" label="pgVector">
    ### pgVector 設定 {/* #pgvector-configuration */}
  ...
  <TabItem value="chroma" label="Chroma">
    ### Chroma 設定 {/* #chroma-configuration */}
  ...
  <TabItem value="turbopuffer" label="Turbopuffer">
    ### Turbopuffer 設定 {/* #turbopuffer-configuration */}
  ...
  <TabItem value="multiple-configs" label="多項設定">
    ### 多項資料庫設定 {/* #multiple-database-configurations */}
...
## 範例：使用 request context {/* #example-using-request-context */}
...
## 不使用 Mastra server 的用法 {/* #usage-without-a-mastra-server */}
...
## 多租戶應用程式的動態 vector store {/* #dynamic-vector-store-for-multi-tenant-applications */}
