...
### 所有 Tool 均須核准 {/* #require-approval-for-all-tools */}
...
### 使用函數動態核准 {/* #dynamic-approval-with-a-function */}
...
### 使用受信任伺服器的 Tool annotations {/* #use-tool-annotations-from-a-trusted-server */}
...
## 伺服器 instructions {/* #server-instructions */}
...
### Stdio 伺服器的子程序環境 {/* #subprocess-environment-for-stdio-servers */}
...
### 使用 `allowedHosts` 限制對外連線的主機 {/* #restricting-outbound-hosts-with-allowedhosts */}
...
### 將 Tool 回應視為不受信任的輸入 {/* #treat-tool-responses-as-untrusted-input */}
...
##### `ElicitationHandler` 函數 {/* #elicitationhandler-function */}
...
## 使用自訂 fetch 處理 runtime 定義的驗證 {/* #using-custom-fetch-for-runtime-defined-authentication */}
...
## 在自訂 fetch 內處理驗證失敗 {/* #handling-auth-failures-inside-custom-fetch */}
...
## 使用 SSE 要求 header {/* #using-sse-request-headers */}
