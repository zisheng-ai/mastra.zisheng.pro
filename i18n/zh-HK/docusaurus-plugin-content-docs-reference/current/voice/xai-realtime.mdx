...
<PropertiesTable
  ...
  },
  {
    name: 'speaker',
    type: 'XAIVoice',
    description: '語音輸出所使用的語音 ID。內置值為 eve、ara、rex、sal 和 leo，亦支援自訂 xAI 語音 ID。',
    isOptional: true,
    defaultValue: "'eve'",
  },
  {
  ...
  },
  {
    name: 'debug',
    type: 'boolean',
    description: '啟用所接收 xAI 事件的偵錯記錄。偵錯記錄可能包含轉錄文字及 Tool 呼叫引數。',
    isOptional: true,
    defaultValue: 'false',
  },
]}
...
### `commitAudioBuffer()` 及 `clearAudioBuffer()` {/* #commitaudiobuffer-and-clearaudiobuffer */}
...
### Mastra 函數 Tool {/* #mastra-function-tools */}
...
### xAI 伺服器端 Tool {/* #xai-server-side-tools */}
