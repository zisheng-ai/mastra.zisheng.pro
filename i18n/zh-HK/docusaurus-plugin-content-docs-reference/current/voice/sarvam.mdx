    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            type: 'number',
            description: '控制音訊速度。bulbul:v2（範圍 0.3–3.0）及 bulbul:v3（範圍 0.5–2.0）均支援。',
            isOptional: true,
          },
          {
            name: 'properties.temperature',
            type: 'number',
            description: '控制所產生語音隨機程度的取樣溫度。只適用於 bulbul:v3。範圍：0.01–2.0。預設值：0.6。',
            isOptional: true,
          },
          {
          ...
          },
          {
            ...
            type: 'boolean',
            description: '啟用英文詞語及數值實體（數字、日期等）的標準化。只適用於 bulbul:v2。預設值為 false。',
            isOptional: true,
          },
          {
