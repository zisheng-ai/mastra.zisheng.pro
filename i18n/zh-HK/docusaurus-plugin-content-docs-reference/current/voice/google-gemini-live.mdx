...
<PropertiesTable
  ...
  },
  {
    name: 'project',
    type: 'string',
    description: 'Google Cloud 專案 ID（使用 Vertex AI 時必須提供）。',
    isOptional: true,
  },
  {
    name: 'location',
...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'event',
    description:
      '模型請求調用 Tool 時發出。回呼會接收 { name: string, args: object, id: string }。',
  },
  {
    name: 'usage',
    type: 'event',
  ...
  },
  {
    ...
    type: 'event',
    description:
      '發生錯誤時發出。回呼會接收 { message: string, code?: string, details?: unknown }。',
  },
