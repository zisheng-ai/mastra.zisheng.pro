...
### Provider 特定配置 {/* #provider-specific-configurations */}
            ...
            properties: [
              {
                ...
                parameters: [
                  ...
                  },
                  {
                    ...
                    isOptional: true,
                    description: '目標執行緒使用中，而 Mastra 接受訊息時合併至訊息的屬性。',
                  },
                ],
              },
            ],
            ...
            properties: [
              {
                ...
                parameters: [
                  ...
                  },
                  {
                    ...
                    type: 'Record<string, string | number | boolean>',
                    isOptional: true,
                    description: '目標執行緒閒置，而 Mastra 接受訊息時合併至訊息的屬性。',
                  },
                ],
              },
            ],
            ...
            properties: [
              {
                ...
                parameters: [
                  ...
                  },
                  {
                    ...
                    type: 'Record<string, string | number | boolean>',
                    isOptional: true,
                    description: '目標執行緒使用中，而 Mastra 接受訊號時合併至訊號的屬性。',
                  },
                ],
              },
            ],
            ...
            properties: [
              {
                ...
                parameters: [
                  ...
                  },
                  {
                    ...
                    type: 'Record<string, string | number | boolean>',
                    isOptional: true,
                    description: '目標執行緒閒置，而 Mastra 接受訊號時合併至訊號的屬性。',
                  },
                ],
              },
            ],
                ...
                parameters: [
                  {
                    ...
                    type: 'AgentExecutionOptions',
                    isOptional: true,
                    description: '即時通知喚醒閒置執行緒時啟動之串流的選項。',
                  },
                ],
              },
            ],
...
<PropertiesTable
  ...
  },
  {
    ...
    isOptional: true,
    description: '用於在用戶端分類或篩選 Agent 的可選中繼資料。可以是靜態記錄，或從請求上下文解析中繼資料的函式。',
  },
  {
    name: 'instructions',
...
SystemMessage 類型：string | string[] | CoreSystemMessage | CoreSystemMessage[] | SystemModelMessage | SystemModelMessage[]`,
  ...
  },
  {
    ...
    isOptional: true,
    description: 'Agent 可存取的 Tool。可靜態提供，或在可用時從請求上下文及相關 Mastra 實例動態解析。',
  },
  {
    name: 'hooks',
    type: 'ToolHooks',
        ...
        parameters: [
          {
            ...
            isOptional: true,
            description: '控制通知記錄的傳送方式。可配置預設決策、各優先級決策、各來源決策，或自訂 `decide()` 函式。',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    type: '(Processor | ProcessorWorkflow)[] | ({ requestContext: RequestContext }) => (Processor | ProcessorWorkflow)[] | Promise<(Processor | ProcessorWorkflow)[]>',
    isOptional: true,
    description: '在 Agent 的訊息傳送至用戶端前修改或驗證訊息的輸出處理器。可以是個別 Processor 物件或 Workflow。',
  },
  {
  ...
  },
  {
    ...
    isOptional: true,
    description: '控制編輯器可覆寫此程式碼定義 Agent 的哪些欄位。省略時允許編輯指示及 Tool。請參閱下方的編輯器覆寫。',
  },
]}
/>
