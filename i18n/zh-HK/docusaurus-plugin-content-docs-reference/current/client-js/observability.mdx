...
## 取得指定 Trace {/* #getting-a-specific-trace */}
...
## 篩選 Trace {/* #getting-traces-with-filtering */}
...
## 列出清單檢視所需的 Trace {/* #listing-traces-for-a-list-view */}
...
## 按 span 取得評分 {/* #getting-scores-by-span */}
...
### 按時間查詢意見回饋 {/* #querying-feedback-over-time */}
