...
# MastraBrowser class {/* #mastrabrowser-class */}
...
<PropertiesTable
  ...
  },
  {
    name: 'timeout',
    type: 'number',
    description: '預設逾時時間（毫秒）。每個 Provider 都會自行定義其語意及預設值，詳情請參閱相應 Provider 的參考文件。',
    isOptional: true,
  },
  {
    name: 'cdpUrl',
