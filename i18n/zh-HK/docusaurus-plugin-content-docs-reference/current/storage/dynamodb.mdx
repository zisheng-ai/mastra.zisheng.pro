...
- **外部資料表佈建：** 此配接器_要求_你在使用前自行建立及設定 DynamoDB 資料表及其全域次要索引（GSI）。請按照 [TABLE\_SETUP.md](https://github.com/mastra-ai/mastra/blob/main/stores/dynamodb/TABLE_SETUP.md) 中的指南操作。
