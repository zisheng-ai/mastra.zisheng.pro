...
# Aurora DSQL Storage {/* #aurora-dsql-storage */}
...
<PropertiesTable
  ...
  },
  {
    name: 'pool',
    type: 'pg.Pool',
    description: '預先設定的 pg.Pool 實例。需要直接控制連線池時使用。不可與 host 設定同時使用。',
    isOptional: true,
  },
  {
    name: 'user',
  ...
  },
  {
    ...
    type: 'number',
    description: '連線生命週期上限（秒）。由於 Aurora DSQL 的連線上限為 60 分鐘，此值必須小於 3600。',
    isOptional: true,
    default: '3300',
  },
  {
...
### 指定 Schema 的索引 {/* #schema-specific-indexes */}
