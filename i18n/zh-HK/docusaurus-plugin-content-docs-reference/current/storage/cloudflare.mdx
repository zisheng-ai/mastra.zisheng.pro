...
# Cloudflare 儲存 {/* #cloudflare-storage */}
...
## Cloudflare KV 儲存 {/* #cloudflare-kv-storage */}
...
### 一致性及傳播 {/* #consistency--propagation */}

Cloudflare KV 是最終一致的 store，意即寫入資料後，資料未必可以即時在所有區域使用。

### Key 結構及 namespace {/* #key-structure--namespacing */}
...
## Cloudflare Durable Objects 儲存 {/* #cloudflare-durable-objects-storage */}
