...
# MastraAuthWorkos 類別 {/* #mastraauthworkos-class */}
...
<PropertiesTable
  content={[
  {
    name: 'apiKey',
    type: 'string',
    description: '你的 WorkOS API 金鑰。這用於向 WorkOS API 進行身份驗證，以驗證用戶及管理機構。',
    isOptional: true,
  ...
  },
  {
    name: 'clientId',
    type: 'string',
    description: '你的 WorkOS Client ID。使用授權碼交換 access token 時，這會識別你的應用程式。',
    isOptional: true,
...
## 服務 token 和 JWT claim {/* #service-tokens-and-jwt-claims */}
