...
## 如何建立自訂 scorer {/* #how-to-create-a-custom-scorer */}
...
## 重試 judge 請求 {/* #retry-judge-requests */}
...
### 覆蓋單一步驟的重試設定 {/* #override-retries-for-one-step */}
...
### Agent 類型捷徑 {/* #agent-type-shortcut */}
...
### 使用泛型的自訂類型 {/* #custom-types-with-generics */}
...
### 內置 Agent 類型 {/* #built-in-agent-types */}
...
## 使用 Agent 類型進行 Trace 評分 {/* #trace-scoring-with-agent-types */}
