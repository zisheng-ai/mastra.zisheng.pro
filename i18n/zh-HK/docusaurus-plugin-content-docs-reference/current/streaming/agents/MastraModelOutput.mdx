    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            name: 'from',
            type: 'ChunkFrom',
            description: '來源：分塊 (AGENT, WORKFLOW, etc.)',
          },
          {
            name: 'payload',
    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            description: '回應 messages in model format',
          },
          {
            name: 'uiMessages',
            type: 'UIMessage[]',
            isOptional: true,
            description: '回應 messages in UI format, includes any 中繼資料 added by 輸出 processors',
          },
        ],
      },
    ],
