...
<PropertiesTable
  ...
  },
  {
    ...
    description: 'UI 用於呈現畫面的標準 AgentControllerDisplayState 快照。請參閱下方的顯示狀態方法。',
  },
  {
    name: 'state',
...
### 訊息及執行控制 {/* #messages-and-run-control */}
