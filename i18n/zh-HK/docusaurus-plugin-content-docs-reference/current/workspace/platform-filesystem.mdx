...
設定平台憑證。存取 token、專案 ID 及 bucket 名稱會使用環境變數作為後備值，因此 Mastra Platform 部署可在不傳入任何建構函式選項的情況下運作。
...
<PropertiesTable
  ...
  },
  {
    name: 'projectId',
    type: 'string',
    description: '平台專案 ID。若未提供，則使用 MASTRA_PROJECT_ID 環境變數。',
    isOptional: true,
  },
  {
    name: 'bucketName',
    type: 'string',
    description:
      '用於儲存檔案的平台 bucket 名稱。若未提供，則使用 MASTRA_PLATFORM_BUCKET_NAME 環境變數。',
    isOptional: true,
  },
  {
    name: 'readOnly',
