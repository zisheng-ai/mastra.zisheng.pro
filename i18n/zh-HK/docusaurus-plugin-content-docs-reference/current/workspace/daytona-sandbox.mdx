...
### 配備資源的自訂映像檔 {/* #custom-image-with-resources */}
...
### 掛載檔案系統 {/* #filesystem-mounting */}

將 S3 或 GCS bucket 掛載為 Sandbox 內的本機目錄。

#### 透過 Workspace 掛載設定 {/* #via-workspace-mounts-config */}
...
#### 與 S3 相容（Cloudflare R2、MinIO） {/* #s3-compatible-cloudflare-r2-minio */}
...
## 背景 process {/* #background-processes */}
