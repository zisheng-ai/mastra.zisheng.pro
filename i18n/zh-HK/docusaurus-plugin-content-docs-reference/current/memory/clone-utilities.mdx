---
title: "參考：Cloned thread utility | Memory"
description: "在 Mastra Memory 中處理 cloned thread 的 utility method 文件。"
packages:
  - "@mastra/memory"
---

# Cloned thread utility {/* #cloned-thread-utilities */}
...
<PropertiesTable
  content={[
  {
    name: 'thread',
    type: 'StorageThreadType',
    description: '要從中擷取 clone metadata 的 thread 物件。',
    isOptional: false,
  },
]}
/>
...
<PropertiesTable
  content={[
  {
    name: 'threadId',
    type: 'string',
    description: 'Cloned thread 的 ID。',
    isOptional: false,
  },
]}
/>
...
<PropertiesTable
  content={[
  {
    name: 'sourceThreadId',
    type: 'string',
    description: '要為其尋找 clone 的 source thread ID。',
    isOptional: false,
  },
]}
/>
...
<PropertiesTable
  content={[
  {
    name: 'threadId',
    type: 'string',
    description: '要取得 clone 記錄的 thread ID。',
    isOptional: false,
  },
]}
/>
