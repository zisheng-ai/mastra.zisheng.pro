...
<PropertiesTable
  ...
  },
  {
    name: 'resourceId',
    type: 'string',
    description: '擁有此 thread 的資源 ID。如有提供，系統會驗證 thread 的擁有權，並會把它傳至 extractor context。',
    isOptional: true,
  },
  {
    name: 'lastMessages',
    type: 'number',
    description: '只總結 thread 的最後 N 則訊息。預設會載入整個 thread，但受 `maxInputTokens` 限制。',
    isOptional: true,
  },
  {
    name: 'maxInputTokens',
    type: 'number',
    description: '當收集到的訊息超出此預計 token 數量時，停止載入更舊的訊息。系統必定會包括最新一則訊息。',
    isOptional: true,
  ...
  },
  {
    name: 'instructions',
    type: 'string',
    description: '附加至 summarizer system prompt 的額外指引，例如應集中處理的內容，或總結的目標讀者。',
    isOptional: true,
  },
  {
    name: 'extract',
...
<PropertiesTable
  ...
  },
  {
    ...
    description: '未能產生有效值的 extractor，以及失敗原因。只有至少一個 extractor 失敗時才會出現。',
  },
  {
    name: 'usage',
