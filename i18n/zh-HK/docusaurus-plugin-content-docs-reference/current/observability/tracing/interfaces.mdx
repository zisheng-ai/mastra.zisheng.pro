...
<PropertiesTable
  ...
  },
  {
    name: 'timestamp',
    type: 'Date',
    description: '記錄 score 的時間。Exporter 會收到 Date 物件，經 JSON 序列化後會成為 ISO 8601 字串。',
    required: true,
  },
  {
    name: 'traceId',
  ...
  },
  {
    name: 'scoreSource',
    type: 'string',
    description: '用來識別 score 產生方式的自由格式字串。常見值包括 manual、automated 及 experiment。',
  },
  {
    name: 'score',
    type: 'number',
...
`workflow_step`、`tool`、`workflow_run` 及 `memory`。
...
## Config selector 類型 {/* #config-selector-types */}
