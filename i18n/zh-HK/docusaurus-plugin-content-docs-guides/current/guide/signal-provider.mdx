...
# 建立訊號 Provider {/* #building-a-signal-provider */}
...
## 加入通知儲存 {/* #add-notification-storage */}
...
## 建立外部服務用戶端 {/* #create-the-external-service-client */}
...
## 建立訊號 Provider {/* #build-the-signal-provider */}
...
## 測試訊號 Provider {/* #test-the-signal-provider */}
