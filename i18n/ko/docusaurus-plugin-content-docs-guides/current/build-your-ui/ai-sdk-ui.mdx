...
Tool은 다음을 사용하여 데이터를 스트리밍할 수도 있습니다.`context.writer.write()` 더 세밀하게 제어하거나 Agent의 스트림을 Tool의 writer로 직접 파이프할 수 있습니다. 자세한 내용은 [Tool Streaming](/docs/agents/using-tools#streaming).
...
* 스트림이 완료된 후에도 Tool은 여전히 자체 출력을 반환합니다.
