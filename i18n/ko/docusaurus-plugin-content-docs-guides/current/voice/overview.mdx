...
<Tabs>
  <TabItem value="openai" label="OpenAI">
    ...
    방문[OpenAI Voice Reference](/reference/voice/openai) 에서 OpenAI 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="azure" label="Azure">
    ...
    방문[Azure Voice Reference](/reference/voice/azure) 에서 Azure 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="elevenlabs" label="ElevenLabs">
    ...
    방문[ElevenLabs Voice Reference](/reference/voice/elevenlabs) 에서 ElevenLabs 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="playai" label="PlayAI">
    ...
    방문[PlayAI Voice Reference](/reference/voice/playai) 에서 PlayAI 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="google" label="Google">
    ...
    방문[Google Voice Reference](/reference/voice/google) 에서 Google 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="cloudflare" label="Cloudflare">
    ...
    방문[Cloudflare Voice Reference](/reference/voice/cloudflare) 에서 Cloudflare 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="deepgram" label="Deepgram">
    ...
    방문[Deepgram Voice Reference](/reference/voice/deepgram) 에서 Deepgram 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="inworld" label="Inworld">
    ...
    방문[Inworld Voice Reference](/reference/voice/inworld) 에서 Inworld 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="speechify" label="Speechify">
    ...
    방문[Speechify Voice Reference](/reference/voice/speechify) 에서 Speechify 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="sarvam" label="Sarvam">
    ...
    방문[Sarvam Voice Reference](/reference/voice/sarvam) 에서 Sarvam 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="murf" label="Murf">
    ...
    방문[Murf Voice Reference](/reference/voice/murf) 에서 Murf 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem value="openai" label="OpenAI">
    ...
    방문[OpenAI Voice Reference](/reference/voice/openai-realtime) 에서 OpenAI 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="google" label="Google">
    ...
    방문[Google Gemini Live Reference](/reference/voice/google-gemini-live) 에서 Google Gemini Live 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="aws-nova-sonic" label="AWS Nova Sonic">
    ...
    방문[AWS Nova Sonic Reference](/reference/voice/aws-nova-sonic) 에서 AWS Nova Sonic 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="inworld-realtime" label="Inworld Realtime">
    ...
    방문[Inworld Realtime Reference](/reference/voice/inworld-realtime) 에서 Inworld Realtime 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
  ...
  <TabItem value="xai" label="xAI">
    ...
    방문[xAI Realtime Voice Reference](/reference/voice/xai-realtime) 에서 xAI 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem value="xai-realtime" label="xAI Realtime">
    ...
    방문[xAI Realtime Voice Reference](/reference/voice/xai-realtime) 에서 xAI 실시간 음성 Provider에 관한 자세한 정보를 확인하세요.
  </TabItem>
