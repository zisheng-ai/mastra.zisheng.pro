...
* [**Firecrawl브라우저**](/docs/browser/firecrawl): 호스팅된 브라우저 세션에 대해 AgentBrowser Tool을 실행하는 Firecrawl 브라우저 샌드박스 제공자입니다. 로컬 브라우저 인프라를 관리하지 않고 호스팅된 브라우저 세션에서 자동화를 실행하는 데 가장 적합합니다.
