  ...
  content={[
{
  name: 'thread',
  type: 'StorageThreadType',
  description: '복제 메타데이터를 추출할 스레드 객체입니다.',
  isOptional: false,
},
]}
/>
  ...
  content={[
{
  name: 'sourceThreadId',
  type: 'string',
  description: '복제본을 찾을 원본 스레드의 ID입니다.',
  isOptional: false,
},
]}
/>
  ...
  content={[
{
  name: 'threadId',
  type: 'string',
  description: '복제 기록을 조회할 스레드의 ID입니다.',
  isOptional: false,
},
]}
/>
